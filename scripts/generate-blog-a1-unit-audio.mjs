...
const CLIPS_BY_UNIT = {
  ...
  60: {
    'two-tomatoes': 'I need two tomatoes for the salad.',
    'where-vegetables': 'Where are the vegetables?',
    'apples-countable': 'Apples and eggs are countable.',
    'milk-uncountable': 'Milk, water, bread and rice are uncountable.',
    'some-eggs': 'We need some eggs for the cake.',
    'any-milk': "There isn't any milk in the fridge.",
    'how-much-water': 'How much water do you want?',
    'how-many-apples': 'How many apples do you need?',
    'too-small': 'This shirt is too small for me.',
    'big-enough': 'These shoes are big enough.',
    'would-like-chicken': 'I would like the chicken for main course please.',
    'the-bill': 'Can I have the bill please?',
    'first-boil': 'First boil the water.',
    'then-add-pasta': 'Then add the pasta.',
    'should-rest': 'You should rest when you are ill.',
    'shouldnt-work': "You shouldn't go to work if you have a fever.",
    'paid-for-dinner': 'I paid for the dinner with cash.',
    'change-receipt': 'Here is your change and your receipt.',
    'shopping-day-story': "Last week I went to the supermarket and bought some apples, some milk and bread. I don't have much money this month so I didn't buy any dessert. On Saturday I cooked pasta. First I boiled the water. Then I added the pasta. Finally I served it with sauce. I feel a bit ill today — I have a headache. I should rest and take some medicine.",
    'dialogue-review': "I would like the chicken for main course please. Anything else? Can I have the bill please? I paid for dinner with cash yesterday but today I only have credit card. No problem. Here is your receipt. I feel a bit ill — headache. You should rest and take medicine.",
    'aisle-two': 'Where are the vegetables? In aisle two.',
    'bigger-size': 'Do you have a bigger size?',
    'recipe-steps': 'First cut the vegetables. Then mix the ingredients. Finally bake for twenty minutes.',
    'medicine-cash': 'I paid for the medicine with cash.',
  },
};
