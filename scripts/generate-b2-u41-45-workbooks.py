...
WRITING = {
    ...
    42: [
        ...
        ("Redacta 45–55 palabras contrastando *to be analysing / to have analysed*.", "Modelo: The laboratory **is said to be analysing** the latest samples now, so the process is still under way. A separate team **is believed to have analysed** the earlier data already, which places that action before the present report during the current stage of the study."),
    ...
    43: [
        ...
        ("Redacta 35–45 palabras con *should, ought to, supervisor*.", "Modelo: You **should contact** your **supervisor** when a research problem appears. You **ought to send** a clear question before the tutorial so that your supervisor can prepare useful feedback and the relevant sources for every meeting."),
        ("Escribe 45–55 palabras con *don't need to, mustn't, academic misconduct*.", "Modelo: You **don't need to print** digital articles, because the lecturer accepts online notes. However, you **mustn't copy** sentences without a reference. Plagiarism is **academic misconduct**, even when only one paragraph has been taken from another writer, and may lead to a formal disciplinary process later."),
