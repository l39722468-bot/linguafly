...
Estado: **0 publicados**, **500 pendientes**.
...
|---|---|---|
| 0 | 4 pilares (`nucleo`) | Definición usable, primera sesión, prompt, qué no pegar |
...
| 5 | `escritura` + `estudio` | Entregables y exámenes, con ética |
