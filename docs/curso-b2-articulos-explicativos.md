# Curso B2 — Artículos explicativos (seguimiento)
...
**IndexNow:** solo tras merge a `main` + deploy + HTTP 200.
...
## Módulo 1: Transición B1 → B2 (U1–10)

| U | Título | Gramática / tema | Teoría | Cuaderno |
|---|---|---|---|---|
| 1 | Repaso B1 → B2 | wish/regret, participle clauses, mixed conditionals; personal development | ✅ | ✅ |
| 2 | Future tenses & Work | will, going to, future perfect; work | ✅ | ✅ |
| 3 | Gerund vs Infinitive (1) & Education | gerund/infinitive; education | ✅ | ✅ |
| 4 | Gerund & Object + Infinitive & Leisure | verb + object + inf; leisure | ✅ | ✅ |
| 5 | Repaso 1–4 | integración | ✅ | ✅ |
| 6 | Wish / If only & Feelings | wish/if only; feelings | ✅ | ✅ |
| 7 | Would rather & Family | would rather/prefer, it's time; family | ✅ | ✅ |
| 8 | Mixed conditionals & Travel | mixed conditionals; travel | ✅ | ✅ |
...
**U31–35 completo (teoría + cuadernos).**
...
**Módulo 4 completo (teoría + cuadernos U31–40).**
