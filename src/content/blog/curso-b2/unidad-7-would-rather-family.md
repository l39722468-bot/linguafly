...
related_routes:
  ...
  - ingles-b2
faqs:
  - question: ¿Rather o prefer?
    answer: >-
      **Would rather + infinitivo sin to**. **Would prefer + to + infinitivo** (o sustantivo + to + sustantivo).
  - question: ¿It's time + pasado?
    answer: >-
      Sí: It's time we **left** (= ya toca / debería haber pasado). También *It's high / about time*.
  - question: ¿Rather + sujeto?
    answer: >-
      I'd rather **you came** early = preferencia sobre la acción de otra persona (pasado en forma).
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 7 del curso B2](/curso-b2/unit-7).
excerpt: >-
  Guía de la Unidad 7 del curso B2: would rather / prefer, It's time y family.
---
Tras [Wish & If only](/blog/curso-b2/unidad-6-wish-if-only-feelings), la **Unidad 7** trabaja **would rather / prefer** e **It's time** con vocabulario de **family**.

> **Practica en el curso:** [Unidad 7](/curso-b2/unit-7)  
> **Antes:** [U6 — Wish & If only](/blog/curso-b2/unidad-6-wish-if-only-feelings)
...
![Would rather family B2](/blog/curso-b2/unit-7/would-rather-prefer.png)

---

## 1. Would rather / would prefer / It's time
...
*Would rather* **no** lleva *to*. *Would prefer* **sí** suele llevar *to* + infinitivo.
...
- Blog: [U8 — Mixed conditionals + travel](/blog/curso-b2/unidad-8-mixed-conditionals-travel)

### Guías relacionadas

- [U6 Wish](/blog/curso-b2/unidad-6-wish-if-only-feelings)
