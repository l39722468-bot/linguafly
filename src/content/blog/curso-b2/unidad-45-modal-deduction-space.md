...
description: >-
  Domina must, might, could y can't + be/have para deducción B2 con exploración espacial, audio y ejercicios resueltos.
readTime: 32 min
keywords:
...
faqs:
  ...
  - question: ¿Dónde practico la Unidad 45?
    answer: >-
      En la [Unidad 45 del curso B2](/curso-b2/unit-45) y su [cuaderno con soluciones](/blog/curso-b2/unidad-45-modal-deduction-space-ejercicios-soluciones).
excerpt: >-
  Guía B2 de deducción modal presente, continua y pasada con evidencias y vocabulario de exploración espacial.
---
...
> **Cuaderno de ejercicios:** [Unidad 45 con soluciones](/blog/curso-b2/unidad-45-modal-deduction-space-ejercicios-soluciones)<br>
...
Completa: *The signal matches our frequency. It ___ from the rover.*

<details><summary>Ver solución</summary>

**Must be**: la evidencia apoya una conclusión fuerte.
</details>

### Ejercicio 2

Elige: *Scientists are unsure; life (must/might) exist elsewhere.*

<details><summary>Ver solución</summary>

**Might exist**: posibilidad abierta.
</details>

### Ejercicio 3

Corrige: *That light mustn't be a star; stars do not move like that.*

<details><summary>Ver solución</summary>

**That light can't be a star.**
</details>

### Ejercicio 4

Completa en pasado: *They look excited. They ___ something unusual.*
...
Da dos explicaciones posibles del mismo dato.

<details><summary>Ver solución</summary>

Ejemplo: **The signal might be noise, or it could come from a probe.**
</details>

### Ejercicio 6

Contrasta: *must be exploring / must have explored*.

<details><summary>Ver solución</summary>

La primera deduce una acción en curso; la segunda, una acción anterior.
</details>

### Ejercicio 7

Corrige: *The rover might has reached Mars.*

<details><summary>Ver solución</summary>

**The rover might have reached Mars.**
</details>

### Ejercicio 8

Distingue *probe, rover* y *satellite*.

<details><summary>Ver solución</summary>

La **probe** investiga sin tripulación; el **rover** se mueve en una superficie; el **satellite** orbita.
</details>

### Ejercicio 9

Repara: *arrive to Mars and make a rocket launch*.

<details><summary>Ver solución</summary>

**Arrive on Mars / reach Mars and launch a rocket.**
</details>

### Ejercicio 10

Producción: escribe 170–200 palabras sobre datos de una misión.

<details><summary>Ver solución</summary>

Usa presente, pasado y acción en curso; incluye trece deducciones justificadas y doce términos espaciales.
</details>
...
No empieces por el modal. Formula primero la evidencia, decide cuánto permite concluir y localiza el evento en presente o pasado. Después construye la cadena completa.

---

## Resumen rápido

| Evidencia y tiempo | Forma |
| :--- | :--- |
...
### ¿Qué modal expresa una deducción fuerte positiva?

**Must**: *The signal must be from the rover; they must have landed*.

### ¿Cómo expreso una posibilidad?

Con **might** o **could** + verbo base; para pasado, *might/could have + participle*.

### ¿Cómo rechazo una posibilidad?

Con **can't + be/base** en presente y **can't have + participle** para un evento anterior.

### ¿Must en U45 expresa obligación?

No en estos ejemplos. Expresa una conclusión fuerte basada en evidencia; el contexto decide la función.

### ¿Dónde practico la Unidad 45?
