...
related_routes:
  ...
  - ingles-b2
faqs:
  - question: ¿Qué gramática repasa la Unidad 50?
    answer: >-
      Integra U41–49; la lección viva enfatiza Future Perfect, deducción modal, mixed conditionals, clefts, reporting verbs e inversión.
  - question: ¿Cómo identifico la estructura correcta?
    answer: >-
      Busca primero la pista de función: verbo controlador, atribución, regla, límite, evidencia, relación temporal, foco o expresión negativa frontal.
  - question: ¿También se repasa vocabulario?
    answer: >-
      Sí. Reúne educación, ciencia, universidad, salud, espacio, psicología, escritura académica, EdTech y sociología.
  - question: ¿Conviene memorizar las respuestas?
    answer: >-
      No. Clasifica, recupera la forma, explica la pista y transfiérela a un ejemplo nuevo.
  - question: ¿Dónde practico la Unidad 50?
    answer: >-
      En la [Unidad 50 del curso B2](/curso-b2/unit-50).
excerpt: >-
  Unidad 50 B2: teoría y ejercicios de repaso de U41–49 con mapa de decisiones, vocabulario mixto, reading, ocho audios y soluciones.
---
La **Unidad 50** consolida la gramática y el vocabulario de **U41–49**. Su lección viva combina Future Perfect, modal deduction, mixed conditionals, cleft sentences, reporting verbs e inversion; esta guía también recupera los patrones, el passive reporting y los modales de U41–43.
...
![Repaso B2 de gramática y vocabulario de las unidades 41 a 49](/blog/curso-b2/unit-50/review-41-49-map.png)
...
Para producción, planifica tres funciones antes de escribir. Por ejemplo: una predicción completada, una recomendación atribuida y una consecuencia contrafactual. Añade foco o inversión solo donde mejore el discurso. La variedad cuenta cuando cada elección es correcta y funcional, no cuando acumulas estructuras sin conexión.## 9. Del reconocimiento a la producción B2

Reconocer una opción correcta no garantiza que puedas producir **las nueve familias gramaticales y el vocabulario de educación, ciencia, salud, espacio, psicología, escritura, innovación y sociedad** sin apoyo. Trabaja cada ejemplo en tres vueltas. Primero localiza la pista de significado: qué tiempo se relaciona con cuál, qué elemento recibe foco, quién recomienda una acción o qué expresión exige inversión. Después tapa la solución y reconstruye la frase completa. Por último cambia sujeto, tiempo y un detalle de **Repaso 41–49**. La estructura solo está disponible para comunicar cuando sobrevive a esa transferencia.

Contrasta decisiones cercanas en vez de memorizar frases sueltas: **forma parecida / función distinta; presente / pasado / futuro; atribución / certeza; orden neutro / foco / inversión**. Para cada pareja, escribe una oración válida, una incorrecta y una explicación que nombre la pista. «Suena bien» no es una regla reutilizable. Una explicación útil dice, por ejemplo, que un resultado contiene *now*, que el foco es una persona, que *urge* necesita un objeto, o que una expresión negativa ha pasado al inicio.

Aprende bloques recuperables: **enjoy studying, is believed to work, must cite, will have completed, might have changed, if we had invested, what matters is, suggest using y never have I seen**. Pronúncialos como unidades y añade después información nueva. Una tarjeta eficaz muestra una intención en español y exige la oración inglesa completa. Otra muestra dos formas posibles y pide justificar cómo cambia el significado. Si siempre empiezas desde el inglés visible, entrenas reconocimiento; si empiezas desde la intención, entrenas recuperación.
...
Dedica cinco minutos a clasificar diez ejemplos sin completarlos. Anota únicamente **familia, intención y pista**. Usa otros cinco para producir la forma desde cero. Crea una tabla con esas tres columnas y un ejemplo de **Repaso 41–49**. Empezar por la intención impide depender del orden de una actividad de opción múltiple.
...
Termina con una producción cronometrada: **resume durante cuatro minutos un proyecto educativo y su impacto social; usa al menos una estructura de cada unidad U41–49 y quince términos del bloque**. Habla o escribe sin consultar tablas. Revisa cuatro criterios: estructura completa, elección justificable, vocabulario preciso y mensaje coherente. Repite la tarea al día siguiente, tres días después y una semana más tarde, reduciendo el apoyo en cada sesión.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-50/practice-u50.mp3" title="🔊 Práctica guiada Unidad 50"></audio>
...
- [ ] Uso vocabulario de **Repaso 41–49** en ejemplos propios.
...
Completa: *By next year, I ___ from university.*

<details><summary>Ver solución</summary>

**Will have graduated**: resultado completo antes del límite futuro.
</details>

### Ejercicio 2

Elige por evidencia fuerte: *She ___ exhausted; she has worked all day.*
...
Completa: *If we ___ earlier, results would be better now.*

<details><summary>Ver solución</summary>

**Had invested**: pasado → presente.
</details>

### Ejercicio 4

Enfatiza: *The students asked for more examples.*

<details><summary>Ver solución</summary>

**It was the students who asked for more examples.**
</details>

### Ejercicio 5

Reporta la propuesta: *Let's use blended learning.*

<details><summary>Ver solución</summary>

**She suggested using blended learning** o **suggested that we use it**.
</details>

### Ejercicio 6

Invierte: *I have never seen such dedication.*
...
Transforma: *People believe the method works.*

<details><summary>Ver solución</summary>

**The method is believed to work** / **It is believed that the method works**.
</details>

### Ejercicio 8

Corrige la norma: *The seminar is optional, so you mustn't attend.*
...
Clasifica *evidence, thesis statement, cognition, demographics*.

<details><summary>Ver solución</summary>

Ciencia/argumentación; escritura académica; psicología; sociología y población.
</details>

### Ejercicio 10

Producción: escribe 190–220 palabras de repaso integrado.

<details><summary>Ver solución</summary>

Usa una estructura de cada U41–49, quince términos, conectores y una explicación final de dos contrastes.
</details>
...
No empieces por el hueco. Lee la oración completa, nombra la función y la pista, recupera el patrón y solo entonces comprueba la forma.
...
### ¿Qué gramática repasa la Unidad 50?

Integra U41–49; la lección viva enfatiza Future Perfect, deducción modal, mixed conditionals, clefts, reporting verbs e inversión.

### ¿Cómo identifico la estructura correcta?
...
### ¿Conviene memorizar las respuestas?

No. Clasifica, recupera la forma, explica la pista y transfiérela a un ejemplo nuevo.

### ¿Dónde practico la Unidad 50?
...
Este artículo incluye también los **ejercicios de la Unidad 50** con soluciones comentadas. Haz cada bloque **sin mirar** la solución. Luego comprueba y lee la explicación.

## Lección 1 — Gramática y chunks

**Objetivo:** seleccionar y construir correctamente las nueve familias gramaticales de U41–49 mediante pistas de función, tiempo, foco y complemento.
...
### Ejercicios 1–5 — U41–U43: patrón, atribución y modalidad

Clasifica la función y recupera la estructura completa.

1. Students enjoy ___ in seminars.
   Opciones: *participating · to participate · participate*
2. People believe the method works.
   Opciones: *The method is believed to work. · The method is believed that it works.*
...
1. **participating** — *Enjoy + -ing* (U41).
2. **The method is believed to work.** — Reporting passive con sujeto + infinitivo (U42).
3. **don't have to** — Ausencia de obligación (U43).
4. **The tutor asked us to cite the source.** — Objeto + infinitivo y pronombre objeto (U41).
5. **to have discovered the pattern** — Infinitivo perfecto para hecho anterior (U42).

</details>

### Ejercicios 6–10 — U44–U46: límite, evidencia y condición

Localiza el tiempo y el grado de certeza antes de completar.

6. By June, the team ___ the trial.
   Opciones: *will have completed · will complete yesterday · has complete*
7. Valid data arrived; the mission ___ completely.
   Opciones: *can't have failed · mustn't fail · can't failed*
8. If we had invested earlier, access ___ better now.
   Opciones: *would be · would have been then · is*
9. By the time regulators ___, the findings will have been published.
   Opciones: *meet · will meet · met tomorrow*
10. If she were more confident, she ___ last year's post.
   Opciones: *might have accepted · might accept yesterday · had accepted*

<details>
<summary>Ver solución</summary>

6. **will have completed** — Future Perfect antes de un límite (U44).
7. **can't have failed** — La evidencia descarta un hecho pasado (U45).
8. **would be** — Pasado irreal → presente (U46).
9. **meet** — La cláusula temporal futura usa presente (U44).
10. **might have accepted** — Estado presente → resultado pasado (U46).

</details>

### Ejercicios 11–15 — U47–U49: foco, reporte e inversión

Distingue qué recibe foco, qué complemento exige el verbo y qué expresión activa inversión.

11. Maya wrote the report. (enfoca Maya)
   Opciones: *It was Maya who wrote the report. · What Maya wrote who the report.*
12. The teacher suggested ___ a flipped classroom.
   Opciones: *trying · to try · try*
13. I have never seen such engagement.
   Opciones: *Never have I seen such engagement. · Never I have seen such engagement.*
14. Corrige: *The advisor urged they attending training.*
15. The evidence matters most.
   Opciones: *What matters most is the evidence. · What it matters most are evidence.*

<details>
<summary>Ver solución</summary>

11. **It was Maya who wrote the report.** — It-cleft de persona (U47).
12. **trying** — *Suggest + -ing* (U48).
13. **Never have I seen such engagement.** — Auxiliar antes del sujeto (U49).
14. **The advisor urged them to attend training.** — *Urge + object + to + base* (U48).
15. **What matters most is the evidence.** — What-cleft sin *it* redundante (U47).
...
**Objetivo:** comprender y usar vocabulario de *Education, Science, Psychology, Writing, Teaching & Society* en situaciones concretas.
...
1. curriculum
   Opciones: *plan educativo global · lista de participantes · resultado clínico*
2. findings
   Opciones: *resultados interpretados de un estudio · reglas del campus · hipótesis inicial*
3. efficacy
   Opciones: *capacidad de producir el efecto deseado · duración del curso · diversidad cultural*
4. cognition
   Opciones: *procesos mentales de pensamiento · objeto en órbita · fuente bibliográfica*
5. globalisation
   Opciones: *intensificación de conexiones mundiales · recuperación médica · evaluación continua*

<details>
<summary>Ver solución</summary>

1. **plan educativo global**
2. **resultados interpretados de un estudio**
3. **capacidad de producir el efecto deseado**
4. **procesos mentales de pensamiento**
5. **intensificación de conexiones mundiales**
...
6. A substantial task assigned by a tutor is an ___.
   Opciones: *assignment · assessment method · orbit*
7. Data supporting a conclusion is ___.
   Opciones: *evidence · empathy · dosage*
8. A vehicle moving across another world's surface is a ___.
   Opciones: *rover · satellite · bibliography*
9. The central claim of an academic text is its ___.
   Opciones: *thesis statement · side effect · webinar*
10. A population count is a ___.
   Opciones: *census · clinical trial · seminar*
...
11. Scientists first ___.
12. Students must ___.
13. A trial team will ___.
14. Writers use sources to ___.
15. A community project may ___.

<details>
<summary>Ver solución</summary>

11. **form a hypothesis**
12. **submit an assignment**
13. **measure efficacy**
14. **support a claim**
15. **improve digital inclusion**

</details>

---

## Lección 3 — Reading: An education project with social impact

**Objetivo:** comprender la idea global, localizar datos y reconocer los objetivos en contexto.

> By next June, a university partnership will have completed a project on digital access and student wellbeing. The programme is believed to have improved engagement in three communities. Students must cite every source, although they do not have to print their reports. What the research team values most is reliable evidence. One lecturer suggested using a flipped classroom, while an advisor urged teachers to provide technical support. If the university had invested earlier, more rural learners would have broadband access now. It was the student interviews that revealed the strongest connection between anxiety and digital exclusion. Never had the researchers expected such varied findings. The final report might influence future policy, but the team will not call the project a breakthrough until an independent group has analysed the data.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-50/reading-workbook.mp3" title="🔊 Reading: An education project with social impact"></audio>
...
1. What will the partnership have completed by June?
2. How many communities took part?
3. What do students not have to print?
4. What did the student interviews reveal?
5. Who will analyse the data independently?

<details>
<summary>Ver solución</summary>

1. **A project on digital access and student wellbeing.**
2. **Three.**
3. **Their reports.**
4. **A connection between anxiety and digital exclusion.**
5. **An independent group.**
...
11. **U44**
12. **possibility**
13. **investment gap → project → interviews → independent analysis**
14. **Because independent analysis has not yet been completed.**
15. **Any four of passive reporting, obligation, Future Perfect, deduction, mixed conditionals, clefts, reporting verbs and inversion.**

</details>

---

## Lección 4 — Listening: Dr Lee closes Module 5

**Objetivo:** identificar información y expresiones completas a velocidad natural.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-50/listening-workbook.mp3" title="🔊 Listening: Dr Lee closes Module 5"></audio>
...
> Welcome to the end of Module Five. By Friday, you will have reviewed nine grammar families and the vocabulary that connects them. What I want to emphasise is accurate choice, not decorative complexity. A result may be reported cautiously, and strong evidence must support a strong deduction. If I had known how useful contrast tables were, I would have introduced them earlier. It was the students who suggested using short retrieval tasks. Our advisor urged us to include speaking practice, and we insisted that every model show the target structure. Never have I seen confidence grow through passive rereading alone. Explain each clue, correct each chain and transfer it to a new context.
...
1. Who is speaking?
2. When will learners have reviewed the module?
3. What matters more than decorative complexity?
4. Who suggested retrieval tasks?
5. What practice did the advisor request?
...
6. **will have reviewed**
7. **would have introduced**
8. **who**
9. **The target structure.**
10. **Passive rereading alone.**
...
11. **passive**
12. **requirement**
13. **classify clue → complete chain → correct error → transfer**
14. **No.**
15. **Explain each clue, correct each chain and transfer it.**
...
**Objetivo:** producir mensajes controlados con las nueve familias gramaticales de U41–49 mediante pistas de función, tiempo, foco y complemento.
...
1. Completa U41: *Students enjoy ___ (study) together.*
2. Transforma U42: *People believe the method works.*
3. Contrasta U43: opcional / prohibido.
4. Completa U44–46: *By June... / It must... / If we had...*
5. Transforma U47–49: foco / propuesta / inversión.
6. Escribe 35–45 palabras con una estructura de U41, U42 y U43.
7. Redacta 35–45 palabras con una estructura de U44, U45 y U46.
8. Escribe 45–55 palabras con una estructura de U47, U48 y U49.
9. Escribe 50–60 palabras conectando ocho términos de cuatro temas del módulo.
10. Escribe 100–120 palabras como cierre del módulo. Incluye al menos una estructura de cada U41–49 y quince términos del bloque.

<details>
<summary>Ver modelos de writing</summary>

1. Students enjoy **studying** together.
2. **The method is believed to work.**
3. Modelo: You **don't have to attend** the optional webinar. You **mustn't plagiarise** its transcript.
4. Modelo: By June, we **will have finished**. It **must be** reliable. If we had invested, access **would be** better now.
5. Modelo: **It was Maya who** proposed it. She **suggested testing** it. **Only then did we agree**.
6. Modelo: Students **enjoy working** in seminars, and the method **is believed to improve** engagement. They **must cite** every source, but they **don't have to print** the final report because the university accepts secure digital submissions on time.
7. Modelo: By June, researchers **will have analysed** the evidence. The result **might have been influenced** by access. If the university **had invested** earlier, rural learners **would have** more reliable broadband now and could participate more confidently.
8. Modelo: **What the interviews revealed was** a serious access gap. The advisor **recommended that the university provide** technical support. **Only after the team compared rural and urban responses did it understand** how infrastructure, cost, confidence and persistence combined to influence participation in the online learning programme.
9. Modelo: The **curriculum** requires each student to submit an **assignment** that cites scientific **evidence** and interprets the **findings**. One report measures treatment **efficacy**; another examines **cognition** and **empathy**. A third uses a **census** to explain how migration, digital access and globalisation may shape community identity and preserve a clear formal register.
10. Modelo: Students **enjoy analysing** how education affects society. The project **is believed to have improved** **student engagement**, and everyone **must cite** reliable **evidence**. By Friday, the team **will have published** its **findings**. The rural sample **might have faced** weaker **broadband** access. If the university **had invested** earlier, participation **would be** higher now. **What the interviews revealed was** a link between **anxiety** and digital exclusion. **It was Maya who** drafted the **thesis statement**. She **suggested using** shorter surveys, and the advisor **urged researchers to include** older residents. **Never had the team expected** such varied **demographics**. The final **report** connects **curriculum**, **efficacy**, **cognition**, **empathy**, **migration**, **identity** and **globalisation** without claiming that one factor explains every community.
...
11. Clasifica oralmente las nueve familias.
12. Explica cómo eliges una respuesta en 30 segundos.
13. Role-play de revisión entre estudiante y tutor.
14. Conecta cuatro redes léxicas.
15. Resume el módulo durante 90 segundos con una estructura de cada U41–49 y quince términos.

<details>
<summary>Ver guiones y pistas de speaking</summary>

11. Guion modelo: **pattern, attribution, rule, deadline, evidence, unreal time link, focus, reported proposal, frontal trigger** correspond to U41–49.
12. Guion modelo: I identify the function and time, build the whole chain, then compare options and reject any form that changes the intended meaning.
13. A: I wrote *Never I have seen*. B: The frontal negative triggers inversion: **Never have I seen**. Now create a new example.
14. Guion modelo: A **curriculum** sets an **assignment**; a trial produces **findings**; **cognition** shapes beliefs; a **census** reveals demographic trends.
15. Pistas: usa el mismo inventario del writing 10; marca nueve estructuras en tus notas y comprueba cada una al terminar.
...
*Guía alineada con la Unidad 50 del [curso B2 de Linguafly](/curso-b2).*
