...
description: >-
  Aprende verb + object + infinitive (convince, tell, ask…) en inglés B2 con vocabulario de leisure. Guía Unidad 4 con audios.
readTime: 15 min
keywords:
  - verb object infinitive B2
  - convince tell ask English
...
alt: 'Verb object infinitive B2 leisure'
related_routes:
  - unidad-3-gerund-infinitive-education
  - unidad-5-repaso-1-4
  - ingles-b2
faqs:
  - question: ¿Convince + to?
    answer: >-
      **Convince + object + to + infinitive**: He **convinced me to join**.
  - question: ¿Tell vs ask?
    answer: >-
      **Tell** = orden/información. **Ask** = petición: She **asked me to wait**.
  - question: ¿Want + object + to?
    answer: >-
      Sí: She **wants me to take up** birdwatching.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 4 del curso B2](/curso-b2/unit-4).
excerpt: >-
  Guía de la Unidad 4 del curso B2: verb + object + infinitive y vocabulario de leisure.
---
Tras la [Unidad 3](/blog/curso-b2/unidad-3-gerund-infinitive-education), la **Unidad 4** presenta **verb + object + infinitive** con vocabulario de **leisure**.

> **Practica en el curso:** [Unidad 4](/curso-b2/unit-4)  
...
- **convince / persuade + obj + to**
- **tell / ask + obj + to**
- **want / would like + obj + to**
- **advise / allow + obj + to**
- Vocabulario: leisure
...
Patrón fijo: **verbo + persona + to + infinitivo**. No omitas el *to* ni el objeto.
...
- CEFR B2 · Cambridge B2 First · British Council — Verb patterns
