...
description: >-
  Aprende wish/regret, participle clauses y mixed conditionals en inglés B2 con vocabulario de personal development. Guía Unidad 1 con audios.
readTime: 15 min
keywords:
  - repaso B1 B2
  - wish if only English
...
alt: 'Repaso B1 a B2 wish regret'
related_routes:
  - ingles-b2
  - unidad-2-future-tenses-work
  - gramatica-ingles-b1-guia
faqs:
  - question: ¿Wish + pasado perfecto?
    answer: >-
      **I wish / If only + past perfect** para arrepentimientos pasados: I wish I **had studied**.
  - question: ¿Participle clause -ed o -ing?
    answer: >-
      **-ed** = pasiva (Encouraged by…); **-ing** = activa (Motivating the team…). **Having + pp** = acción completada antes.
  - question: ¿Mixed conditional?
    answer: >-
      Pasado irreal → presente: If he **had taken** medicine, he **would feel** better **now**.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 1 del curso B2](/curso-b2/unit-1).
excerpt: >-
  Guía de la Unidad 1 del curso B2: puente B1 → B2 con wish, participle clauses y mixed conditionals.
---
Empiezas el [curso B2](/blog/metodos/ingles-b2) con la **Unidad 1** (*Repaso B1 → B2*): activas **wish/regret**, **participle clauses** y **mixed conditionals** con vocabulario de **personal development**.

> **Practica en el curso:** [Unidad 1](/curso-b2/unit-1)  
...
- **I wish / If only + past perfect / could**
- **Regret + gerund**
...
*Wish + past perfect* no es pasado narrativo: expresa un deseo sobre algo que **ya no puedes cambiar**.
...
- [Gramática B1](/blog/gramatica/gramatica-ingles-b1-guia)

---

## Fuentes

- CEFR B2 · Cambridge B2 First · British Council — Wish, clauses & conditionals
