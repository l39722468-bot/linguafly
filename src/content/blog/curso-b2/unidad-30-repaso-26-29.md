...
description: >-
  Repasa GET/GIVE/GO, LOOK/MAKE/PUT y collocations verbo+sustantivo y adjetivo+sustantivo de B2 con ejercicios, reading, audio y soluciones completas en la...
readTime: 60 min
keywords:
...
faqs:
  ...
  - question: ¿Cómo sé si necesito un phrasal verb o una collocation?
    answer: >-
  ...
  - question: ¿Cuál es el error más frecuente del repaso?
    answer: >-
  ...
  - question: ¿Debo volver a estudiar las cuatro unidades completas?
    answer: >-
...
---
La **Unidad 30** cierra el segundo bloque del Módulo 3 y reúne cuatro sistemas: phrasal verbs **GET/GIVE/GO** de U26; **LOOK/MAKE/PUT** de U27; colocaciones **verbo + sustantivo** con *make, take, have* de U28; y colocaciones **adjetivo + sustantivo** de U29. El vocabulario mezcla sostenibilidad, música, gastronomía y psicología.
...
![Repaso B2 Unidades 26 a 29 phrasal verbs y collocations](/blog/curso-b2/unit-30/review-map.png)

---

## 1. El mapa del bloque U26–29
...
Reconocer una respuesta en una lista no demuestra todavía dominio B2. En una actividad de opción múltiple, las alternativas te recuerdan qué palabras existen; en una conversación real no aparece ese apoyo. Para convertir **los phrasal verbs de U26–27 y las collocations de U28–29** en lenguaje disponible, trabaja en tres vueltas. Primero lee los ejemplos completos y explica en español por qué esa combinación encaja. Después tapa la expresión y reconstruye la frase. Por último cambia el sujeto, el tiempo verbal y un detalle del contexto de **el repaso integrado de sostenibilidad, música, gastronomía y psicología**. Si la estructura sobrevive a esos cambios, ya no estás repitiendo una línea de memoria.

La segunda vuelta debe incluir contraste. Pon juntas dos opciones que suelen competir: **get over/get through, give up/give in, make up/make up for, make/take/have y strong/heavy/great**. Escribe una frase correcta con cada una y añade una tercera frase deliberadamente incorrecta. Al corregir tu propio error tienes que formular la regla, no limitarte a decir "suena mejor". Esa explicación breve —qué significa, qué complemento admite y qué escena sugiere— fortalece la recuperación. También ayuda a detectar interferencias del español, porque obliga a observar la combinación inglesa completa.
...
Termina con cinco minutos de producción: **presenta un evento comunitario durante dos minutos e integra tres phrasals de cada familia y seis colocaciones**. Grábate sin leer y escucha una vez con una rúbrica sencilla: precisión del chunk, claridad del mensaje, variedad y autocorrección. No reinicies la grabación por un error; corrígelo dentro del discurso con *I mean…* o repitiendo la frase bien. Esa reparación es una destreza comunicativa real. Una producción de sesenta segundos clara y revisada vale más que cinco minutos improvisados sin objetivo.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-30/practice-u30.mp3" title="🔊 Práctica guiada Unidad 30"></audio>
...
- [ ] Creo un ejemplo propio relacionado con **el repaso integrado de sostenibilidad, música, gastronomía y psicología**.
...
Antes de rellenar, etiqueta el hueco: **phrasal**, **verb+noun** o **adjective+noun**. Esa pausa de un segundo evita combinar piezas de unidades distintas y te obliga a recuperar una expresión completa.
...
**Objetivo:** seleccionar y construir correctamente GET/GIVE/GO; LOOK/MAKE/PUT; collocations MAKE/TAKE/HAVE + noun; adjective + noun collocations.
...
### Ejercicios 1–5 — Diagnóstico U26–27: phrasal verbs
...
1. **got through** — Completar un periodo difícil = *get through*.
2. **give up / give in** — Abandonar frente a ceder.
3. **look into** — Investigar un asunto.
4. **made up for** — Compensar conserva *for*.
5. **put up with** — Tolerar = *put up with*.

</details>

### Ejercicios 6–10 — Diagnóstico U28: verbo + sustantivo
...
6. **made** — Pasado de *make a decision*.
7. **took** — Pasado de *take responsibility*.
8. **had** — Objetivo del curso: *have a look at*.
9. **made** — *Make progress*; sin artículo.
10. **take** — *Take a note of*.

</details>

### Ejercicios 11–15 — Diagnóstico U29 y mezcla final

Corrige exactamente una palabra o expresión en cada frase.

11. The volunteers worked under *strong pressure*.
12. Families gave us *complete support*.
13. We made *a great progress* before opening.
14. We look forward to *attend* the next festival.
15. The event *went out well* despite the rain.

<details>
<summary>Ver solución</summary>

11. **The volunteers worked under heavy pressure.** — *Heavy pressure* es el chunk objetivo.
12. **Families gave us full support.** — *Full support* = apoyo completo.
13. **We made great progress before opening.** — *Progress* es incontable.
14. **We look forward to attending the next festival.** — Preposición *to* + *-ing*.
15. **The event went off well despite the rain.** — Evento que sale bien = *go off well*.
...
**Objetivo:** comprender y usar vocabulario de *sustainability, music, gastronomy y psychology* en frases concretas.
...
1. **U26 sostenibilidad** · 2. **U27 música** · 3. **U28 gastronomía** · 4. **U29 psicología** · 5. **U26 sostenibilidad**
...
6. **venue** · 7. **recipe** · 8. **burden** · 9. **compost** · 10. **audience**
...
11. The café wants to ___ glass jars.
12. The band completed its final ___.
13. The chef contacted the local ___.
14. The tutor offered the students full ___.
15. The festival reduced its ___.

<details>
<summary>Ver solución</summary>

11. **reuse** · 12. **rehearsal** · 13. **supplier** · 14. **support** · 15. **carbon footprint**

</details>

---

## Lección 3 — Reading: A sustainable food and music festival

**Objetivo:** comprender la idea global, localizar datos y reconocer los chunks en contexto.

> A community organised a sustainable food and music festival. The team went through every supplier and looked into renewable energy for the venue. They did not give up when the original promoter put off the booking. A new promoter made up for the delay, and the chef took responsibility for a low-waste menu. After having a look at the ingredients, she made a decision to reuse glass containers. Heavy pressure created strong anxiety, but full support from volunteers helped everyone make great progress. The audience put up with a short wait, the band went on at eight, and the festival went off well. Its deep impact encouraged more sustainable events.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-30/reading-workbook.mp3" title="🔊 Reading: A sustainable food and music festival"></audio>
...
1. What type of festival did the community organise?
2. What energy option did the team investigate?
3. Who postponed the original booking?
4. What did the new promoter make up for?
5. What menu did the chef take responsibility for?

<details>
<summary>Ver solución</summary>

1. **A sustainable food and music festival.**
2. **Renewable energy.**
3. **The original promoter.**
4. **The delay.**
5. **A low-waste menu.**
...
6. Complete U26: They did not ___ when the booking changed.
7. Complete U27: The promoter ___ the delay.
8. Complete U28: The chef ___ to reuse glass.
9. Complete U29: Volunteers offered ___ support.
10. Complete mixed: The festival ___ well.
...
11. Classify *went through every supplier*: U26, U27, U28 or U29?
12. Classify *took responsibility*: U26, U27, U28 or U29?
13. Correct the article: *made a great progress*.
14. Which two phrases describe psychological pressure and help?
15. Put in order: supplier review — booking delay — menu decision — successful festival.
...
11. **U26**
12. **U28**
13. **made great progress**
14. **strong anxiety; full support**
15. **supplier review → booking delay → menu decision → successful festival**

</details>

---

## Lección 4 — Listening: The organiser reviews festival day

**Objetivo:** identificar información y expresiones completas a velocidad natural.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-30/listening-workbook.mp3" title="🔊 Listening: The organiser reviews festival day"></audio>
...
> Hi, I'm Ravi, the festival organiser. We got through the planning stage, although we nearly gave up. The promoter looked into the venue problem and made up for the delay. Our chef had a look at the ingredients, made a decision and took responsibility for the local menu. There was heavy pressure and some strong anxiety, but volunteers gave us full support. The audience put up with a short wait while the band looked after its equipment. The event went off well, made a good impression and had a deep impact on the community.
...
1. Who is speaking?
2. What stage did the team complete?
3. Who investigated the venue problem?
4. Who took responsibility for the menu?
5. What did the audience tolerate?

<details>
<summary>Ver solución</summary>

1. **Ravi, the festival organiser.**
...
6. Complete U26: We nearly ___.
7. Complete U27: The promoter ___ the delay.
8. Complete U28: The chef ___ the ingredients.
9. Complete U29: Volunteers gave us ___ support.
10. How did the event go off?
...
11. True/False: The event made a bad impression.
12. Classify *looked after its equipment*.
13. Classify *took responsibility*.
14. Name the two adjective + noun collocations about difficulty.
15. Complete the outcome: It made a good ___ and had a deep ___.
...
11. **False.**
12. **U27 phrasal verb.**
13. **U28 verb + noun collocation.**
14. **heavy pressure; strong anxiety**
15. **impression; impact**
...
**Objetivo:** producir mensajes breves y controlados con GET/GIVE/GO; LOOK/MAKE/PUT; collocations MAKE/TAKE/HAVE + noun; adjective + noun collocations.
...
1. Completa: We ___ the hard stage and didn't ___ to pressure.
2. Corrige: *The promoter made up the delay.*
3. Corrige: *The chef took a decision and made responsibility.*
4. Corrige: *We made a great progress under strong pressure.*
5. Traduce: *Esperamos con ilusión escuchar a la banda.*
6. Traduce: *El público toleró la espera y el evento salió bien.*
7. Escribe una cadena de cuatro chunks: uno de cada U26–29.
8. Redacta 40–50 palabras sobre el menú de un festival. Incluye *have a look, take responsibility, sustainable*.
9. Redacta 40–50 palabras sobre un retraso musical. Incluye *put off, make up for, heavy pressure*.
10. Escribe 90–110 palabras sobre un festival integrado con tres phrasals y cinco collocations.

<details>
<summary>Ver modelos de writing</summary>

1. We **got through** the hard stage and didn't **give in** to pressure.
2. The promoter **made up for** the delay.
3. The chef **made a decision** and **took responsibility**.
4. We **made great progress** under **heavy pressure**.
5. We **look forward to hearing** the band.
6. The audience **put up with** the wait, and the event **went off well**.
7. Modelo: We **went through** the options (U26), **looked into** the venue (U27), **made a decision** (U28) and received **full support** (U29).
8. Modelo: The chef **had a look at** every ingredient and **took responsibility** for a **sustainable** menu. She reused glass jars, chose seasonal dishes and made a call to a local supplier before the deadline.
9. Modelo: The promoter nearly **put off** the gig because the band arrived late. Under **heavy pressure**, the musicians shortened rehearsal. They **made up for** the delay with an acoustic encore, and the audience showed full support.
10. Modelo: Our community planned a zero-waste music festival. We **went through** every supplier and **looked into** renewable energy. The chef **made a decision** to reuse containers and **took responsibility** for the menu. **Heavy pressure** caused **strong anxiety**, but volunteers gave us **full support**. The audience **put up with** a short delay while the band finished rehearsal. Everyone **made great progress**, and the event **went off well**. It made a good impression and had a **deep impact** on future community plans.
...
11. Clasifica oralmente un ejemplo de cada patrón.
12. Role-play entre organizador y promotor por un retraso.
13. Explica y corrige tres errores: *give up to pressure; take a decision; strong pressure*.
14. Resume el reading en cuatro pasos, uno por unidad.
15. Habla 60–75 segundos sobre un festival sostenible con ocho chunks.

<details>
<summary>Ver guiones y pistas de speaking</summary>

11. Guion modelo: **Give up** is a phrasal verb; **take responsibility** is verb+noun; **heavy pressure** is adjective+noun.
12. A: Will we **put off** the festival? B: No. We'll **make up for** the delay with an extra band. A: Good; the audience can **put up with** a short wait.
13. Guion modelo: Say **give in to pressure**, **make a decision** and **heavy pressure**.
14. Pistas modelo: U26 **went through suppliers**; U27 **looked into energy**; U28 **took responsibility**; U29 received **full support**.
15. Pistas modelo: get through · go off well · look into · put up with · make a decision · take responsibility · heavy pressure · full support.
...
*Cuaderno alineado con la Unidad 30 del [curso B2 de Linguafly](/curso-b2).*