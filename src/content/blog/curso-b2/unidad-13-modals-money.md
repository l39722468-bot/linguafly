...
description: >-
  Aprende must, have to, need to, needn't y don't have to en inglés B2 con vocabulario de money & volunteering. Guía Unidad 13 con audios.
readTime: 15 min
keywords:
...
related_routes:
  ...
  - ingles-b2
faqs:
  - question: ¿Must o have to?
    answer: >-
      Ambos expresan obligación. **Must** = hablante / regla interna. **Have to** = obligación externa / reglas.
  - question: ¿Needn't o don't have to?
    answer: >-
      En afirmativo: **need to** = necesidad. En negativo: **needn't** y **don't have to** = no hay obligación (sinónimos en B2).
  - question: ¿Must en pasado?
    answer: >-
      Para pasado usa **had to** (obligación) o **didn't have to / needn't have** según el matiz.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 13 del curso B2](/curso-b2/unit-13).
excerpt: >-
  Guía de la Unidad 13 del curso B2: modals of obligation y vocabulario de money & volunteering.
---
Tras [Reduced relatives](/blog/curso-b2/unidad-12-relative-clauses-reduction), la **Unidad 13** consolida **must / have to / need to / needn't / don't have to** con vocabulario de **money & volunteering**.

> **Practica en el curso:** [Unidad 13](/curso-b2/unit-13)  
> **Antes:** [U12 — Reduced relatives](/blog/curso-b2/unidad-12-relative-clauses-reduction)
...
**Must** suena a regla o consejo del hablante; **have to** a norma externa. En negativo, **needn't** = *no es necesario* (libertad).
