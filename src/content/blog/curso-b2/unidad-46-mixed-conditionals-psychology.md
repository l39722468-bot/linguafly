...
related_routes:
  ...
  - ingles-b2
faqs:
  - question: ¿Cómo se forma el mixed conditional de pasado a presente?
    answer: >-
      Con **if + had + participio** y **would + base**: *If I had studied psychology, I would be a therapist now*.
  - question: ¿Cómo conecto un estado presente con un resultado pasado?
    answer: >-
      Con **if + past/were** y **would have + participio**: *If she were more confident, she wouldn't have given up*.
  - question: ¿En qué se diferencia del tercer condicional?
    answer: >-
      El tercero sitúa condición y resultado en el pasado; el mixto conecta tiempos distintos.
...
![Mixed conditionals B2 con psicología y comportamiento humano](/blog/curso-b2/unit-46/mixed-conditionals-map.png)

---

## 1. Qué mezcla un mixed conditional
...
Dedica cinco minutos a clasificar diez ejemplos sin completarlos. Anota únicamente **familia, intención y pista**. Usa otros cinco para producir la forma desde cero. Crea una tabla con esas tres columnas y un ejemplo de **Psychology & Human Behavior**. Empezar por la intención impide depender del orden de una actividad de opción múltiple.
...
Termina con una producción cronometrada: **explica durante tres minutos cómo decisiones, rasgos y apoyo influyen en el presente; usa cuatro condicionales de cada dirección y diez términos psicológicos**. Habla o escribe sin consultar tablas. Revisa cuatro criterios: estructura completa, elección justificable, vocabulario preciso y mensaje coherente. Repite la tarea al día siguiente, tres días después y una semana más tarde, reduciendo el apoyo en cada sesión.

<audio controls preload="none" src="/audio/blog/curso-b2/unit-46/practice-u46.mp3" title="🔊 Práctica guiada Unidad 46"></audio>
...
- [ ] Uso vocabulario de **Psychology & Human Behavior** en ejemplos propios.
...
Completa: *If I ___ psychology, I would be a therapist now.*

<details><summary>Ver solución</summary>

**Had studied**. La condición es pasada y el resultado con *now* es presente.
</details>

### Ejercicio 2

Corrige: *If she would have sought help, she might feel better today.*

<details><summary>Ver solución</summary>

**If she had sought help, she might feel better today.**
</details>

### Ejercicio 3

Completa: *If he ___ more empathetic, he would have understood yesterday.*

<details><summary>Ver solución</summary>

**Were**. Un rasgo presente irreal explica un resultado pasado.
</details>

### Ejercicio 4

Distingue: *If she were more confident / If she had been more confident*.

<details><summary>Ver solución</summary>

La primera presenta un rasgo vigente; la segunda sitúa la condición únicamente en el pasado.
</details>

### Ejercicio 5

Elige *would/could/might*: solo presentas una posibilidad débil actual.

<details><summary>Ver solución</summary>

**Might**: *If they had received support, they might feel safer now*.
</details>

### Ejercicio 6

Convierte a pasado → presente: no escuchó al terapeuta; hoy no sabe afrontar el estrés.

<details><summary>Ver solución</summary>

**If he had listened to his therapist, he would know how to cope with stress now.**
</details>

### Ejercicio 7

Repara: *If I had knew, I would have helped.*
...
Distingue *empathy, self-awareness* y *self-esteem*.

<details><summary>Ver solución</summary>

Comprender a otros; reconocer estados propios; valoración de uno mismo.
</details>

### Ejercicio 9

Completa colocaciones: *cope ___ stress; show ___; seek professional ___*.

<details><summary>Ver solución</summary>

**Cope with stress; show empathy; seek professional help.**
</details>

### Ejercicio 10

Producción: escribe 170–200 palabras sobre decisiones y bienestar.

<details><summary>Ver solución</summary>

Incluye tres condicionales pasado → presente, tres presente → pasado, un tercero y doce términos de psicología.
</details>
...
Dibuja dos puntos temporales antes de conjugar. Decide dónde ocurre la condición y dónde el resultado; después asigna el bloque completo a cada lado.
...
### ¿Cómo conecto un estado presente con un resultado pasado?

Con **if + past/were** y **would have + participio**: *If she were more confident, she wouldn't have given up*.

### ¿En qué se diferencia del tercer condicional?

El tercero sitúa condición y resultado en el pasado; el mixto conecta tiempos distintos.

### ¿Puedo usar could o might?
