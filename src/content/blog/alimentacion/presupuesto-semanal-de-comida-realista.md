...
title: "Presupuesto semanal de comida realista"
description: >-
  Fija un presupuesto semanal de comida realista: rangos en euros para una o dos
  personas, dónde recortar y cómo rastrear el ticket sin quitar proteína.
readTime: 11 min
keywords:
  - presupuesto comida semanal
  - cuánto gastar en comida a la semana
  - menú semanal económico
  - comida barata con proteína
  - gasto supermercado semanal realista
  - presupuesto alimentación una persona
  - recortar gasto súper sin quitar proteína
excerpt: >-
...
faqs:
  - question: ¿Cuánto gastar en comida a la semana en España?
    answer: "Una persona que cocina en casa suele moverse entre 40 y 70 euros: es un rango tosco, no un examen. Dos personas, entre 75 y 120 si compartís aceite, arroz y botes. El pedido y el bar van aparte."
  - question: ¿Cómo recortar el gasto del súper sin quitar proteína?
    answer: Primero tickets, zumos, snacks de pasillo y la verdura que se pudre. Luego marca blanca en yogur, botes, arroz y avena. Huevos, yogur natural, legumbre y pollo o tofu se quedan.
  - question: ¿El presupuesto de alimentación de una persona incluye el café de máquina?
    answer: No. Café de cafetería, menú del mediodía y apps de comida van en otra línea. Si los mezclas, el súper parece caro y no sabes qué recortar.
  - question: ¿Hace falta un menú semanal económico distinto cada semana?
    answer: No. Tres cenas que ya sepas hacer, repetidas. El ahorro está en no tirar y en no improvisar a las nueve, no en un recetario nuevo.
  - question: ¿Qué hago si esta semana me he pasado del rango?
    answer: "Anota en qué líneas. No ayunes el lunes. La siguiente compra: menos pasillo de snacks, misma proteína, y un recado solo si falta leche o fruta."
---
...
Este texto no enseña a escribir la lista. Eso está en la [lista de la compra semanal sencilla](/blog/alimentacion/lista-de-la-compra-semanal-sencilla). Tampoco es un tutorial de cocinar bases el domingo. Si quieres esa hora, está en [batch cooking de una hora](/blog/alimentacion/batch-cooking-de-una-hora). Aquí se habla de dinero: rangos, cortes, lo que no se toca y cómo rastrear un ticket de verdad.
...
1. **Ajustado:** 40 a 50 euros. Huevos, yogur grande, botes, arroz o avena, pollo o tofu, verdura congelada, fruta barata. Casi nada de marca cara. Casi nada de listo para comer.
2. **Realista:** 50 a 70 euros. Lo de arriba, más un pescado congelado, un queso pequeño, mejor fruta, café y aceite que ya usas. Cabe un extra. No caben tres.
3. **Holgado en casa:** 70 a 90 euros. Sigue siendo cocina. Entra más fresco, algún lácteo de más, un segundo decente. Si pasas de 90 sin pedidos, mira el pasillo de snacks y las bolsas de hoja que no usaste.
...
1. **Ajustado:** 75 a 90 euros.
2. **Realista:** 90 a 120 euros.
3. **Holgado en casa:** 120 a 150 euros.
...
Una [rutina de fuerza para principiantes en casa](/blog/entrenamiento/rutina-fuerza-principiantes-casa) no exige un presupuesto de gimnasio. Exige que en el ticket sigan apareciendo huevos, yogur, botes o pollo. Si el recorte es “quito el pollo y dejo galletas porque salen a 0,12 la unidad”, el rango miente.

Cómo usar el rango hoy:

1. Elige una banda. Una persona, realista: 50 a 70. Escríbela.
2. No elijas “lo más bajo que he visto en un reel”. Elige la que puedes repetir cuatro semanas.
3. Mide siete días. Luego mueves el número. No al revés.
...
1. Abre la app del banco o la carpeta de tickets de los últimos siete días.
2. Marca cada cargo: súper, bar, pedido, recado.
3. Suma solo súper + recado + panadería.
4. Ese es tu **gasto supermercado semanal realista**. Bar, café de máquina y pedido van en otra línea.
...
1. Coge el último ticket. Rodea todo lo que no era cena, desayuno, fruta o proteína.
2. Suma esas líneas. Ese es el recorte fácil.
3. La siguiente compra: mismas tres cenas, sin esas líneas.
4. No toques huevos, yogur natural, botes ni el pollo o tofu del plan.
...
1. Escribe el rango. Ejemplo: 60 euros, una persona.
2. Escribe las tres cenas y los dos desayunos. Sin eso, el carro no tiene techo.
3. Mira nevera y despensa. Lo que ya hay resta del gasto. No del ego: del número.

**En el súper o en la app:**

1. Ve con ese papel. No con el folleto.
2. Si usas la app, mira el subtotal antes de pagar. Si vas por encima, quita lo que no es proteína, hidrato o verdura de las cenas. Quita el snack. No quites los huevos.
3. Foto al ticket. O déjalo en la nevera con un imán. El banco agrupa “alimentación” con el bar. Tú no.

**Durante la semana:**

1. Cada recado, foto o nota: 4,20 leche y plátanos.
2. Cada pedido, otra nota, otra columna.
3. No “ya lo cuadraré”. El miércoles es cuando se te va.

**El domingo siguiente, quince minutos:**

1. Suma súper + recados.
2. Compara con el rango.
3. Escribe tres líneas: qué se comió, qué se tiró, qué sobró en el ticket y no era plan.
4. Ajusta **una** palanca. No cinco. Zumos, yogures de sabores, o más congelado y menos hoja.
