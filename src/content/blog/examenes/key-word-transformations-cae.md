...
faqs:
  - question: "¿Cuántas palabras puedo usar en las Key Word Transformations del CAE?"
    answer: "Entre dos y seis palabras, incluyendo la key word que no puedes cambiar. Las contracciones cuentan como dos palabras: 'don't' equivale a 'do not'. Si necesitas más de seis palabras para que la frase tenga sentido, estás tomando el camino equivocado."
  - question: "¿Puedo cambiar la key word en las transformaciones?"
    answer: "No. La key word no puede modificarse en absoluto: ni añadirle letras, ni cambiarle mayúsculas, ni combinarla con otra palabra para formar una nueva. Si la usas exactamente como aparece, bien. Si la modificas de cualquier manera, la respuesta se considera incorrecta."
  - question: "¿Cuántos puntos vale cada transformación en el CAE?"
...
> KEY WORD: **HAVE**
> *"She \_\_\_\_ meant to upset you."*
...
Ejemplo:
> *"It was a mistake not to read the instructions."*
> KEY WORD: **SHOULD**
...
> *"She had never felt so nervous before."*
> KEY WORD: **NEVER**
> → *"Never **had she felt** so nervous before."*

Para una guía completa de inversiones con todos los tipos y ejemplos, el artículo sobre [inversiones en inglés C1](/blog/examenes/inversiones-ingles-c1) cubre este tema en detalle.
...
> *"It's a shame you didn't study harder. You might have passed."*
> KEY WORD: **STUDIED**
...
> *"A technician repaired the computer for us."*
> KEY WORD: **HAD**
> → *"We **had the computer repaired**."*

> *"Someone cleaned his car."*
> KEY WORD: **GOT**
> → *"He **got his car cleaned**."*
