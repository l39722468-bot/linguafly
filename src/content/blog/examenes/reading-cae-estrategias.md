...
faqs:
  - question: "¿Cuántos textos hay en el Reading del CAE?"
    answer: "Las partes 5 a 8 del Reading and Use of English incluyen cuatro textos o conjuntos de textos. La parte 5 tiene un texto largo con 6 preguntas de opción múltiple; la parte 6 es un texto con párrafos eliminados (gapped text); la parte 7 son varios extractos cortos con 10 preguntas de opción múltiple; y la parte 8 son múltiples textos con 10 preguntas de emparejamiento."
  - question: "¿En qué orden conviene hacer las partes del Reading?"
    answer: "Muchos candidatos prefieren hacer primero la Parte 8 (multiple matching), luego la Parte 5 (multiple choice) y dejar el gapped text (Parte 6) para el final, ya que requiere más concentración. Pero depende de tus puntos fuertes: experimenta en los ensayos."
  - question: "¿Las preguntas del CAE Reading tienen trampas?"
...
canonical: 'https://linguafly.app/blog/examenes/reading-cae-estrategias'
alt: Lector marcando párrafos de un texto de reading del CAE
---
...
Para ver cómo se trabajan el resto de partes del examen, el [hub C1 Advanced (CAE)](/blog/temas/cae-c1-advanced-cambridge) tiene guías específicas para el Listening, el Speaking y el Writing.
...
- British Council LearnEnglish (reading): https://www.britishcouncil.org/learnenglish
