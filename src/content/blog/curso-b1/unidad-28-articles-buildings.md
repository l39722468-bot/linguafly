...
description: >-
  Repasa a/an, the y el artículo cero en inglés B1 con edificios y lugares. Guía Unidad 28 con audios.
readTime: 15 min
keywords:
...
faqs:
  - question: ¿a o an?
    answer: >-
      an delante de sonido vocálico: an old church, an hour, an office.
  - question: ¿cuándo the?
    answer: >-
      Cuando el oyente sabe de qué hablamos: the cathedral, the hospital near here.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 28 del curso B1](/curso-b1/unit-28).
excerpt: >-
  Guía de la Unidad 28 del curso B1: artículos y buildings.
---
Tras la [Unidad 27](/blog/curso-b1/unidad-27-both-either-neither), la **Unidad 28** consolida **a/an, the** y el **artículo cero**, con vocabulario de **edificios y lugares**.

> **Practica en el curso:** [Unidad 28](/curso-b1/unit-28)  
> **Antes:** [U27 — Both, either, neither](/blog/curso-b1/unidad-27-both-either-neither)
...
- **the** (específico / único)
- **sin artículo** (*go to school*)
- Vocabulario: library, hospital, cathedral, stadium…
...
*an* depende del **sonido**, no de la letra: *an hour*, *a university*. Con instituciones (*school, prison, hospital*) el artículo cambia el significado.
...
- [U29 — Reflexives](/blog/curso-b1/unidad-29-reflexive-pronouns)
