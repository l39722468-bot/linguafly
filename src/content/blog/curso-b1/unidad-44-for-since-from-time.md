...
description: >-
  Aprende for, since y from en inglés B1 con time expressions. Guía Unidad 44 con audios.
readTime: 15 min
keywords:
  - for since from B1
...
faqs:
  ...
  - question: ¿from o since?
    answer: >-
      **from…to** = rango; **since** = desde un momento hasta ahora (con perfect).
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 44 del curso B1](/curso-b1/unit-44).
excerpt: >-
  Guía de la Unidad 44 del curso B1: for, since, from y time expressions.
---
Tras la [Unidad 43](/blog/curso-b1/unidad-43-during-for-while-time), la **Unidad 44** profundiza en **for / since / from** con **time expressions**.

> **Practica en el curso:** [Unidad 44](/curso-b1/unit-44)  
...
*For* cuenta **cuánto**; *since* marca **desde cuándo**; *from* suele ir con **to**.
