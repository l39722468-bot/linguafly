...
description: >-
  Práctica gramatical mixta B1 con vocabulario de ciudad y campo. Guía Unidad 58 con audios.
readTime: 15 min
keywords:
...
faqs:
  - question: ¿Qué practica la U58?
    answer: >-
      Gramática mixta con vocabulario de **town & countryside**.
  - question: ¿Incluye there is/are y relativas de lugar?
    answer: >-
      Sí: *There are many shops*, *the village where I grew up*…
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 58 del curso B1](/curso-b1/unit-58).
excerpt: >-
  Guía de la Unidad 58 del curso B1: práctica gramatical mixta con lugares.
---
Tras la [Unidad 57](/blog/curso-b1/unidad-57-mixed-grammar-clothes-colours), la **Unidad 58** practica gramática B1 describiendo **ciudad y campo**.
...
- **Passive**, **would rather**, **there is/are**, **relative where**
- Vocabulario: **city, village, countryside, bridge…**
- **PP continuous** con *since*
- **Second conditional** con lugares
...
Para lugares: *where* (lugar), *which/that* (cosa), *there is/are* (existencia).
...
- [U28](/blog/curso-b1/unidad-28-articles-buildings)
- [U38](/blog/curso-b1/unidad-38-contrast-opinions)
...
- CEFR B1 · Cambridge B1 Preliminary · British Council — Mixed grammar & places
