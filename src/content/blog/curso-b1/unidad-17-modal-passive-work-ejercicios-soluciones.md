...
description: >-
  Practica todos los ejercicios de la Unidad 17 del curso B1: modal passive (must/should/can/might be + past participle); work & jobs, reading, listening y...
readTime: 25 min
keywords:
...
faqs:
  - question: ¿Qué ejercicios incluye la Unidad 17 del curso B1?
    answer: >-
      Cinco lecciones con 15 actividades cada una sobre modal passive (must/should/can/might be + past participle),
  ...
  - question: ¿Cuál es el foco gramatical?
    answer: >-
      modal passive (must/should/can/might be + past participle).
  - question: ¿Dónde practico en el curso?
    answer: >-
      En la Unidad 17 del curso B1 de Linguafly: gramática, vocabulario,
      reading, listening, speaking y writing.
excerpt: >-
  Cuaderno de ejercicios de la Unidad 17 B1 (Modal Passive & Work) con soluciones.
---
Este artículo reúne **los ejercicios de la Unidad 17 del curso B1** (*Modal Passive & Work & Jobs*) con **soluciones comentadas**.

> **Guía teórica:** [Modal Passive & Work B1](/blog/curso-b1/unidad-17-modal-passive-work)  
> **Practica en el curso:** [Unidad 17 — Modal Passive & Work](/curso-b1/unit-17)
...
3. [Lección 3 — Reading: Office deadlines](#leccion-3--reading)
4. [Lección 4 — Listening: Omar at work](#leccion-4--listening)
...
3. The meeting ___ be postponed. → *can / must / should*
4. The interview ___ be cancelled. → *might / must / should*
5. The contract ___ be signed by Friday. → *must / can / might*

<details>
<summary>Ver solución</summary>

1. **must** · 2. **should** · 3. **can** · 4. **might** · 5. **must**
...
4. Work experience should ___ included in your resume. → *be / being / been*
5. The client must ___ informed about the delay. → *be / being / been*

<details>
<summary>Ver solución</summary>

1. **be** · 2. **be** · 3. **be** · 4. **be** · 5. **be**
...
3. *Should be send today.*
4. *Can be postpone.*
5. *Might being cancelled.*

<details>
<summary>Ver solución</summary>

1. It **must be** finished.
2. The form must **be** completed.
3. Should be **sent** today.
4. Can be **postponed**.
5. Might **be** cancelled.
...
3. interview → *entrevista · upload · grammar*
4. salary → *salario · password · translate*
5. resume → *CV · cloud · spoiler*

<details>
<summary>Ver solución</summary>

1. **fecha límite** · 2. **compañero** · 3. **entrevista** · 4. **salario** · 5. **CV**
...
3. client ≈ ___ → *cliente / Wi-Fi / binge*
4. meeting ≈ ___ → *reunión / storm / gig*
5. application ≈ ___ → *solicitud / thunder / forecast*

<details>
<summary>Ver solución</summary>

1. **contrato** · 2. **ascenso** · 3. **cliente** · 4. **reunión** · 5. **solicitud**
...
3. Completa: The report ___ be sent today.
4. Completa: Applications must ___ submitted.
5. Corrige: *Must to be finished.*
6. Corrige: *The form must completed.*
7. Usa *deadline* y *colleague* en 2 frases con modal passive.
8. Escribe: The contract must be signed by Friday.
9. Escribe: The meeting can be postponed.
10. Mini-párrafo sobre un proceso de selección (interview/resume).
11. Traduce: El informe debería enviarse hoy.
...
1. Repasa fallos en la [guía teórica](/blog/curso-b1/unidad-17-modal-passive-work).  
2. Practica en la [Unidad 17 del curso B1](/curso-b1/unit-17).  
3. Siguiente: [Reported Speech Statements](/blog/curso-b1/unidad-18-reported-speech-statements-ejercicios-soluciones).

Guías relacionadas:

- [Teoría Unidad 17](/blog/curso-b1/unidad-17-modal-passive-work)
- [Cuaderno anterior](/blog/curso-b1/unidad-16-passive-voice-technology-ejercicios-soluciones)
- [Inglés B1](/blog/metodos/cursos-online-ingles-b1)

---

*Cuaderno alineado con la Unidad 17 del [curso B1 de Linguafly](/curso-b1).*
