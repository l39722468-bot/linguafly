...
description: >-
  Aprende to, in order to, so that, because y because of en inglés B1. Guía Unidad 39 con audios.
readTime: 15 min
keywords:
  - purpose reason B1
  - in order to so that
...
faqs:
  - question: ¿to o so that?
    answer: >-
      to / in order to + infinitivo; so that + cláusula (sujeto + verbo).
  - question: ¿because o because of?
    answer: >-
      because + cláusula; because of / due to + nombre.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 39 del curso B1](/curso-b1/unit-39).
excerpt: >-
  Guía de la Unidad 39 del curso B1: purpose, reason y explaining.
---
Tras la [Unidad 38](/blog/curso-b1/unidad-38-contrast-opinions), la **Unidad 39** distingue **propósito** y **causa** para **explicar**.

> **Practica en el curso:** [Unidad 39](/curso-b1/unit-39)  
...
- Vocabulario: reason, purpose, therefore…
...
Si tras el conector hay **sujeto + verbo**, usa *because / so that*. Si hay **nombre**, usa *because of / due to*.
