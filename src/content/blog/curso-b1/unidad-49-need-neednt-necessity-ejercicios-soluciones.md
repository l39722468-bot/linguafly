...
faqs:
  - question: ¿Qué ejercicios incluye la Unidad 49 del curso B1?
    answer: >-
      Cinco lecciones con 15 actividades cada una sobre need / needn't / needn't have + necessity,
  ...
  - question: ¿Cuál es el foco gramatical?
    answer: >-
      need / needn't / needn't have + necessity.
  - question: ¿Dónde practico en el curso?
    answer: >-
      En la Unidad 49 del curso B1 de Linguafly: gramática, vocabulario,
      reading, listening, speaking y writing.
excerpt: >-
  Cuaderno de ejercicios de la Unidad 49 B1 (Need & Necessity) con soluciones.
---
Este artículo reúne **los ejercicios de la Unidad 49 del curso B1** (*Need, Needn't & Necessity*) con **soluciones comentadas**.

> **Guía teórica:** [Need & Necessity B1](/blog/curso-b1/unidad-49-need-neednt-necessity)  
> **Practica en el curso:** [Unidad 49 — Need & Necessity](/curso-b1/unit-49)
...
3. [Lección 3 — Reading: No hurry](#leccion-3--reading)
4. [Lección 4 — Listening: Iris on necessity](#leccion-4--listening)
...
3. She needn't ___ bought a new one. → *have / to / -*
4. This needs ___ urgently. → *repairing / to repair / repair*
5. We needn't ___ booked the table. → *have / to / -*
...
4. need + -ing = ___ → *passive meaning / active / future*
5. don't need to ≈ ___ → *needn't / mustn't / shouldn't*

<details>
<summary>Ver solución</summary>

1. **bare infinitive** · 2. **to infinitive** · 3. **past participle** · 4. **passive meaning** · 5. **needn't**
...
3. *She needn't bought.* (missing have)
4. *This needs to repairing.*
5. *We needn't to have booked.*

<details>
<summary>Ver solución</summary>

1. You needn't **hurry**.
2. I need **to** buy a ticket.
3. She needn't **have** bought a new one.
4. This needs **repairing**.
5. We needn't **have** booked the table.
...
3. unnecessary → *innecesario · essential · need*
4. essential → *esencial · optional · needn't*
5. optional → *opcional · necessary · must*

<details>
<summary>Ver solución</summary>

1. **necesidad** · 2. **necesario** · 3. **innecesario** · 4. **esencial** · 5. **opcional**
...
3. need + -ing ≈ ___ → *necesita ser hecho / quiere hacer / ha hecho*
4. don't need to ≈ ___ → *needn't / mustn't / shouldn't*
5. in need of ≈ ___ → *necesitado de / preferencia por / consejo sobre*

<details>
<summary>Ver solución</summary>

1. **no necesitas** · 2. **no era necesario (pasado)** · 3. **necesita ser hecho** · 4. **needn't** · 5. **necesitado de**
...
3. Completa: I need ___ buy a ticket.
4. Completa: She needn't ___ bought.
5. Completa: This needs ___ urgently.
6. Corrige: *You needn't to hurry.*
7. Corrige: *I need buy a ticket.*
8. Usa needn't have y unnecessary en 2 frases.
9. Escribe: We needn't have booked the table.
10. Mini-diálogo (4 frases) con need/needn't.
11. Traduce: No necesitas darte prisa.
...
1. Repasa fallos en la [guía teórica](/blog/curso-b1/unidad-49-need-neednt-necessity).  
2. Practica en la [Unidad 49 del curso B1](/curso-b1/unit-49).  
3. Siguiente: [Repaso 46–49](/blog/curso-b1/unidad-50-repaso-46-49-ejercicios-soluciones).

Guías relacionadas:

- [Teoría Unidad 49](/blog/curso-b1/unidad-49-need-neednt-necessity)
- [Cuaderno anterior](/blog/curso-b1/unidad-48-phrasal-verbs-work-study-ejercicios-soluciones)
- [Inglés B1](/blog/metodos/cursos-online-ingles-b1)

---

*Cuaderno alineado con la Unidad 49 del [curso B1 de Linguafly](/curso-b1).*
