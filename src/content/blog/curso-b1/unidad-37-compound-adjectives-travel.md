...
description: >-
  Aprende adjetivos compuestos (a two-day trip, a 20-year-old) en inglés B1 con viajes. Guía Unidad 37 con audios.
readTime: 15 min
keywords:
...
faqs:
  - question: ¿guion?
    answer: >-
      Sí en adjetivo delante del nombre: a two-day trip.
  - question: ¿plural en el compuesto?
    answer: >-
      No: a **two-day** trip (no *two-days*).
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 37 del curso B1](/curso-b1/unit-37).
excerpt: >-
  Guía de la Unidad 37 del curso B1: compound adjectives y travel.
---
Tras la [Unidad 36](/blog/curso-b1/unidad-36-so-such-intensifiers), la **Unidad 37** presenta **adjetivos compuestos** con vocabulario de **viaje y descripciones**.

> **Practica en el curso:** [Unidad 37](/curso-b1/unit-37)  
> **Antes:** [U36 — So/such](/blog/curso-b1/unidad-36-so-such-intensifiers)

---

## Qué aprenderás

- **número + nombre** (*two-day*)
- **edad** (*20-year-old*)
- **well-known / long-distance…**
- Vocabulario: flight, luggage, sightseeing…
...
Delante del nombre: **guion** y **singular** (*a five-star hotel*, no *five-stars*).
