...
faqs:
  - question: ¿Qué ejercicios incluye la Unidad 11 del curso B1?
    answer: >-
      Cinco lecciones con 15 actividades cada una sobre first conditional + future time clauses (when, as soon as, until),
  ...
  - question: ¿Cuál es el foco gramatical?
    answer: >-
      first conditional + future time clauses (when, as soon as, until).
  - question: ¿Dónde practico en el curso?
    answer: >-
      En la Unidad 11 del curso B1 de Linguafly: gramática, vocabulario,
      reading, listening, speaking y writing.
excerpt: >-
  Cuaderno de ejercicios de la Unidad 11 B1 (First conditional & Weather) con soluciones.
---
Este artículo reúne **los ejercicios de la Unidad 11 del curso B1** (*First Conditional & Weather*) con **soluciones comentadas**.

> **Guía teórica:** [First conditional & Weather B1](/blog/curso-b1/unidad-11-first-conditional-weather)  
> **Practica en el curso:** [Unidad 11 — First conditional & Weather](/curso-b1/unit-11)
...
3. [Lección 3 — Reading: Weekend weather plans](#leccion-3--reading)
4. [Lección 4 — Listening: Anna's weather plans](#leccion-4--listening)
...
3. As soon as the storm ___, I will call. → *passes / will pass / passed*
4. We will stay indoors until the rain ___. → *stops / will stop / stopped*
5. If it's sunny, we ___ have a barbecue. → *will / would / are*
...
4. If there ___ a storm, we will stay indoors. → *is / will be / was*
5. I will tell you when I ___ the forecast. → *see / will see / saw*

<details>
<summary>Ver solución</summary>

1. **come** · 2. **will** · 3. **will** · 4. **is** · 5. **see**
...
3. *As soon as it will pass…*
4. *Until the rain will stop…*
5. *If it's sunny, we would have a barbecue.* (plan real)
...
3. As soon as it **passes**…
4. Until the rain **stops**…
5. If it's sunny, we **will** have a barbecue.
...
3. forecast → *pronóstico · temperatura · humedad*
4. temperature → *temperatura · clima · granizo*
5. drizzle → *llovizna · aguacero · sequía*

<details>
<summary>Ver solución</summary>

1. **soleado** · 2. **tormenta** · 3. **pronóstico** · 4. **temperatura** · 5. **llovizna**
...
3. How hot/cold = ___ → *temperature / forecast / climate*
4. Pronóstico = ___ → *forecast / humidity / hail*
5. Relámpago = ___ → *lightning / thunder / wind*

<details>
<summary>Ver solución</summary>

1. **sunny** · 2. **storm** · 3. **temperature** · 4. **forecast** · 5. **lightning**
...
3. Completa: When I ___, I will call you.
4. Completa: As soon as the storm ___, I will call.
5. Completa: We will stay indoors until the rain ___.
6. Escribe 1 frase con *before* + present + will.
7. Usa *forecast* y *storm* en 2 frases first conditional.
8. Corrige: *If it will rain, I stay home.*
9. Corrige: *When I will arrive, I call you.*
10. Párrafo (3–4 frases) sobre planes de fin de semana y el tiempo.
11. Traduce: Si hace sol, haremos una barbacoa.
...
1. Repasa fallos en la [guía teórica](/blog/curso-b1/unidad-11-first-conditional-weather).  
2. Practica en la [Unidad 11 del curso B1](/curso-b1/unit-11).  
3. Siguiente: [Second conditional](/blog/curso-b1/unidad-12-second-conditional-ejercicios-soluciones).

Guías relacionadas:

- [Teoría Unidad 11](/blog/curso-b1/unidad-11-first-conditional-weather)
- [Cuaderno anterior](/blog/curso-b1/unidad-10-repaso-6-9-ejercicios-soluciones)
- [Inglés B1](/blog/metodos/cursos-online-ingles-b1)

---

*Cuaderno alineado con la Unidad 11 del [curso B1 de Linguafly](/curso-b1).*
