...
description: >-
  Aprende relative clauses explicativas (who/which + comas, sin that) en inglés B1 con vocabulario de medio ambiente. Guía Unidad 32 con audios.
readTime: 15 min
keywords:
...
faqs:
  - question: ¿puedo usar that?
    answer: >-
      No en non-defining: solo who/which + comas.
  - question: ¿para qué sirven las comas?
    answer: >-
      Marcan información extra; si quitas la cláusula, la frase sigue clara.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 32 del curso B1](/curso-b1/unit-32).
excerpt: >-
  Guía de la Unidad 32 del curso B1: non-defining relative clauses y environment.
---
Tras la [Unidad 31](/blog/curso-b1/unidad-31-defining-relative-nature), la **Unidad 32** introduce las **relative clauses explicativas** (con comas) y vocabulario de **medio ambiente**.

> **Practica en el curso:** [Unidad 32](/curso-b1/unit-32)  
> **Antes:** [U31 — Defining relative](/blog/curso-b1/unidad-31-defining-relative-nature)
...
- **who / which + comas**
- **no uses that**
- Vocabulario: recycle, pollution, climate…
...
Si conoces ya a la persona/cosa (*my sister*, *Madrid*, *climate change*), usa **comas** y **who/which** — nunca *that*.
