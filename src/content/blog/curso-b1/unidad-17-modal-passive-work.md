...
faqs:
  - question: ¿Qué es el modal passive?
    answer: >-
      modal + be + past participle: must be completed, should be sent, can be postponed.
  - question: ¿must be o must to be?
    answer: >-
      must **be** + V3. Nunca *must to be*.
  - question: ¿Dónde practico?
    answer: >-
      En la [Unidad 17 del curso B1](/curso-b1/unit-17).
  - question: ¿Qué vocabulario de trabajo?
    answer: >-
      salary, interview, colleague, contract, deadline, promotion, resume…
excerpt: >-
  Guía de la Unidad 17 del curso B1: modal passive y work & jobs.
---
Tras la [pasiva present/past (U16)](/blog/curso-b1/unidad-16-passive-voice-technology), la **Unidad 17** añade **modales** a la pasiva en contextos de **trabajo**.

> **Practica en el curso:** [Unidad 17](/curso-b1/unit-17)  
...
Piensa primero el modal (obligación / consejo / posibilidad) y luego añade **be + V3**.
