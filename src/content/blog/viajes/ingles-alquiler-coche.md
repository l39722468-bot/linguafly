...
category: viajes
faqs:
  - question: '¿Qué documentos necesito para alquilar un coche en Reino Unido o EE. UU.?'
    answer: 'Pasaporte, tarjeta de crédito física (débito suele no servir para la fianza) y carnet de conducir válido. Para EE. UU., el carnet español o latinoamericano suele bastar para estancias cortas; para Reino Unido y Irlanda también. En algunos países asiáticos y en ciertos estados de EE. UU. te pedirán además un permiso internacional de conducir (IDP).'
  - question: '¿Qué tipo de seguro merece la pena contratar?'
    answer: 'Lo mínimo legal ya va incluido. Lo importante es decidir sobre CDW (Collision Damage Waiver, reduce franquicia por daños) y LDW o SLI (cobertura extra de responsabilidad civil). Las "full coverage" en mostrador son caras: a menudo sale mejor contratar un seguro de excess externo (RentalCover, iCarhireinsurance) desde España antes del viaje.'
  - question: '¿Cómo pido un coche automático en inglés?'
    answer: '"I’d like an automatic, please." En Europa, especialmente en países pequeños, predominan los manuales (stick shift). En EE. UU. y Canadá, los automáticos son el estándar. Si reservas online, filtra "Automatic transmission" antes.'
  - question: '¿Qué significa "excess" en el alquiler?'
...
> **Agente:** *"Good afternoon! Who’s the main driver?"*
> **Tú:** *"That’s me. Here’s my booking reference: ABCD-1234."*
> **Agente:** *"Perfect. I’ll need your passport, your driver’s licence, and a credit card in the main driver’s name, please."*
> **Tú:** *"Here you go."*
> **Agente:** *"Great. The car you booked is a Volkswagen Polo, manual. Would you like to upgrade to an automatic for an extra fifteen euros a day?"*
> **Tú:** *"Is automatic a big difference? I can drive manual, so I’ll keep the original car, thanks."*
> **Agente:** *"No problem. Let’s go through the insurance. Your basic coverage has an excess of €1,200. Would you like to reduce it to zero with our Super Cover for €18 per day?"*
> **Tú:** *"Actually, I already have external excess insurance from RentalCover, so I’ll keep the basic coverage, thank you."*
> **Agente:** *"Alright. I’ll need to pre-authorise €1,200 on your credit card as a deposit. That’s a hold, not a charge. Is that OK?"*
> **Tú:** *"Yes, that’s fine. When will the hold be released?"*
> **Agente:** *"About ten days after you return the car in the same condition."*
> **Tú:** *"Perfect. And what’s the fuel policy?"*
> **Agente:** *"Full to full. The tank is full now — please return it full to avoid the refuelling fee."*
...
1. **Decir *"renting a car"* en lugar de *"renting / hiring a car"*.** Ambos valen en EE. UU.; en UK dicen más *"hire"*.
2. **Confundir *"driving licence"* (UK) con *"driver’s license"* (US).** Ambas se entienden.
3. **No diferenciar *"excess"* y *"deductible"*.** Son lo mismo (franquicia), pero *"excess"* se usa en UK/UE y *"deductible"* en EE. UU.
4. **Traducir *"full tank"* como *"full deposit"*.** En inglés es **tank**, no deposit.
5. **Olvidar decir *"please"* y *"thank you"* en mostrador.** Los agentes de rent-a-car en países anglosajones son muy cortés-sensibles. Exigir sin fórmulas de cortesía irrita. Siempre *"Could I…?"*, *"Thanks for your help."*
