...
title: "Puente de glúteo: técnica y progresión"
description: >-
  Puente de glúteos para principiantes: talones, un segundo arriba, sin arco
  lumbar. Colocación, isquios y cómo progresar en casa con tu peso corporal.
readTime: 11 min
keywords:
  - puente de glúteos principiantes
  - cómo hacer puente de glúteo
  - glute bridge técnica
  - puente de glúteo lumbar
  - puente de glúteo en casa
...
faqs:
  - question: ¿Cómo se hace el puente de glúteo si empiezo de cero?
    answer: "Espalda en el suelo, pies a la distancia de las caderas, empujas con los talones. Arriba, un segundo, costillas bajas. Bajas con control. Diez a quince repeticiones bastan."
  - question: ¿Por qué no noto el glúteo en el puente?
    answer: "Sueles empujar con la lumbar o con los isquios. Acerca un poco los pies, reduce el rango, pausa arriba. El arco alto no es el trabajo."
  - question: ¿Por qué se me cargan los isquios en el puente de glúteo?
    answer: "Pies demasiado lejos o no cierras con el glúteo. Acerca los talones, empuja el suelo, rango más corto. Si calambra, paras la serie y recolocas."
  - question: ¿El puente de glúteo hace daño en la lumbar?
    answer: "No si es extensión de cadera. Si arqueas la espalda para ganar altura, sí carga lumbar. Costillas abajo, menos rango. Pinchazo localizado: paras."
  - question: ¿Cuándo hago el puente a una pierna?
...
3. Bajada más lenta: tres segundos.
4. Rango completo limpio, si antes ibas corto por técnica. Completo no significa arco.
5. Más adelante: una pierna. No ahora.
