...
- 10 sentadillas lentas a un aire que te permita control.
- 20 segundos de marcha en el sitio o jumping jack suave.

**Bloque principal (3 vueltas)**

Descansa 60-90 segundos entre ejercicios si lo necesitas. Entre vueltas, 2 minutos.

1. **Sentadilla** — 8 a 12 repeticiones. Baja como si fueras a sentarte en una silla. Rodillas alineadas con los pies. Si las 12 salen fáciles, alarga el tiempo abajo (3 segundos).
2. **Flexión inclinada** (pared o mesa) — 6 a 10. Cuerpo firme, codos a unos 45°. No dejes caer la cadera.
3. **Puente de glúteo** — 10 a 15. Espalda en el suelo, empujas con talones, aprietas glúteo arriba 1 segundo.
4. **Plancha** — 20 a 40 segundos. Si la lumbar se hunde, sube las rodillas. Calidad antes que reloj.
5. **Zancada estática o paso atrás** — 6 a 8 por pierna. Agárrate a una silla si el equilibrio falla. Eso no es trampa; es técnica.
6. **Remo con toalla o mochila** — 8 a 12. Si no tienes nada, aprieta los omóplatos en el suelo boca abajo (Y o W) 8 repeticiones lentas.
