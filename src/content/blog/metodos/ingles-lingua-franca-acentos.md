...
faqs:
  - question: '¿El ELF es una variedad "incorrecta" del inglés?'
    answer: 'No. El English as a Lingua Franca no es inglés mal hablado; es inglés adaptado a un contexto comunicativo específico donde los interlocutores no comparten lengua nativa. Los lingüistas lo estudian como un fenómeno legítimo con sus propias regularidades. Lo que puede parecer "incorrecto" desde el punto de vista del inglés nativo estándar —la simplificación de algunos rasgos morfológicos, el acento del hablante, ciertas construcciones gramaticales— suele ser perfectamente funcional en el contexto ELF, donde el objetivo es la comunicación eficiente, no la adecuación a una norma nativa.'
  - question: '¿Debería intentar sonar como un nativo o como un hablante de ELF?'
    answer: 'Depende de tus objetivos. Si tu uso del inglés es principalmente en contextos internacionales donde tus interlocutores también son no nativos, apuntar a la claridad y la inteligibilidad es más valioso que reproducir un acento nativo específico. Si necesitas integrarte en una comunidad de hablantes nativos —vivir en un país anglófono, trabajar en una empresa donde todos son nativos— adaptar tu habla a la variedad local tiene sentido práctico. La mayoría de las personas que usan el inglés profesionalmente hoy se mueve entre los dos contextos: reuniones internacionales con no nativos y comunicación con nativos. No son mutuamente excluyentes.'
  - question: '¿Los acentos nativos complican la comunicación en ELF?'
    answer: 'A veces, sí. Investigadores del ELF han documentado que los hablantes nativos no siempre son los más fáciles de entender en contextos ELF. Usan más modismos, contracciones, reducción de sonidos y referencias culturales específicas que sus interlocutores no nativos no comparten. Un hablante nativo que no ajusta su habla al contexto puede ser más difícil de entender para un interlocutor no nativo que otro hablante no nativo del mismo nivel. La competencia en ELF incluye saber cuándo y cómo adaptar el habla al contexto.'
...
canonical: 'https://www.focus-on-english.com/blog/metodos/ingles-lingua-franca-acentos'
---
