...
description: >-
  Guía completa del inglés australiano: sus tres variantes (Broad, General y Cultivated), características fonéticas, vocabulario típico y estrategias para...
readTime: 8 min
excerpt: >-
  El australiano es uno de los acentos del inglés que más confunde a quienes
  aprendieron inglés con modelos americanos o británicos. Sus vocales cambiadas,
...
faqs:
  - question: '¿Por qué el inglés australiano suena tan diferente al inglés americano o británico?'
    answer: 'El inglés australiano evolucionó de forma bastante aislada desde la colonización británica a finales del siglo XVIII. Los colonos procedían de diferentes regiones de Gran Bretaña e Irlanda, y sus acentos mezclados dieron lugar a una variedad nueva en pocas generaciones. El aislamiento geográfico permitió que esa variedad se desarrollara de forma independiente, produciendo cambios vocálicos propios que no ocurrieron en el inglés británico ni en el americano. El resultado es un sistema vocálico único, especialmente en las vocales de las sílabas acentuadas, que suena muy diferente a cualquier otro acento del inglés para alguien que no lo ha escuchado antes.'
  - question: '¿Qué diferencia hay entre el Broad, el General y el Cultivated Australian?'
    answer: 'Son los tres grandes grupos en que los lingüistas dividen el espectro del inglés australiano. El Broad es el más marcado, el que se asocia popularmente con el "acento australiano de película": vocales muy desplazadas, entonación característica y uso frecuente de coloquialismos. Crocodile Dundee es el ejemplo de cine. El General Australian es el intermedio, el que habla la mayoría de la población y el que se escucha en la televisión australiana estándar. El Cultivated es el más parecido al RP británico, históricamente asociado con educación formal y clase alta; hoy está en retroceso. La diferencia entre los tres es un continuum, no una frontera nítida.'
  - question: '¿Es verdad que los australianos suben la entonación al final de todas las frases?'
    answer: 'No de todas, pero hay un fenómeno fonético real llamado High Rising Terminal (HRT) o Australian Question Intonation que consiste en usar una entonación ascendente al final de afirmaciones, como si fueran preguntas. Este rasgo existe en el inglés australiano, aunque su frecuencia varía según el hablante, la región y el contexto. Se usa especialmente para asegurarse de que el interlocutor está siguiendo lo que se dice, o en narraciones. No es exclusivo del australiano (existe en el inglés neozelandés, californiano y varios otros), pero sí es más frecuente que en el GA o el RP.'
