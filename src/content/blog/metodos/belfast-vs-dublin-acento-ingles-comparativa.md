...
keywords:
  ...
  - Ulster English vs Irish English
  - Irlanda del Norte acento ingles
...
category: metodos
faqs:
  - question: '¿Es correcto hablar de “acento irlandés único”?'
    answer: 'No es riguroso. Hay un continuo de variedades en la isla de Irlanda y en Irlanda del Norte, con variación social y generacional enorme. Útil como etiqueta turística; insuficiente para lingüística o para entrenamiento serio del oído.'
  - question: '¿El inglés de Belfast se parece al escocés?'
...
|--------|----------------------|-------------------------|
| Moneda | Euro (EUR) | Libra esterlina (GBP) |
| Señalización | Bilingüe gaélico/inglés frecuente en carreteras | Contexto UK + señales propias |
| Transporte público | Vocabulario irlandés + internacional | Léxico UK (*single/return* en billetes) |
| Pequeño comercio | *Grand*, *craic* muy reconocibles | Algunas formas compartidas, otras más alineadas con UK norte |
