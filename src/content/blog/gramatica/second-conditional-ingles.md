...
category: gramatica
faqs:
  - question: ¿Cuándo debo usar "were" en lugar de "was" en el second conditional?
    answer: >-
      Gramaticalmente, en inglés formal se prefiere "were" para todas las personas
      en el segundo condicional: "If I were you", "If he were here", "If she were
      taller". En conversación informal, "was" es muy común y no se considera un
      error grave. En exámenes Cambridge, usa siempre "were" para demostrar que
      conoces la norma.
  - question: ¿Cuál es la diferencia entre "would" y "could" en el second conditional?
    answer: >-
      "Would" expresa el resultado principal (lo que harías). "Could" expresa
      posibilidad o capacidad en ese escenario hipotético. "If I had more time,
      I would travel" (resultado seguro en la hipótesis). "If I had more time,
      I could travel more" (estarías en disposición de viajar, sería posible).
  - question: ¿El second conditional siempre habla del presente o futuro irreal?
    answer: >-
...
canonical: 'https://linguafly.app/blog/gramatica/second-conditional-ingles'
---
...
1. If I _____ (be) you, I _____ (apologize) immediately.
2. She _____ (be) happier if she _____ (have) more free time.
3. If we _____ (start) earlier, we _____ (not be) in this mess now.
4. What _____ (you / do) if you _____ (lose) your job tomorrow?
