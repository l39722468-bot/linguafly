...
image: 'https://images.pexels.com/photos/3808803/pexels-photo-3808803.jpeg?auto=compress&cs=tinysrgb&w=1200'
alt: Persona reflexionando sobre el pasado usando el third conditional en inglés
category: gramatica
faqs:
  - question: ¿Por qué el third conditional usa "had + participio" en la cláusula con if?
    answer: >-
      Porque el third conditional habla de situaciones pasadas que no ocurrieron.
      El "past perfect" (had + participio) es el tiempo que usamos para
      referirnos a algo anterior a otro punto en el pasado, y aquí marca que la
      condición nunca se cumplió. Es una forma de crear distancia entre la
      realidad y la hipótesis.
  - question: ¿Puedo usar "could have" o "might have" en lugar de "would have"?
    answer: >-
      Sí. "Could have" expresa que habría sido posible: "If she had applied,
      she could have got the job" (habría tenido la posibilidad). "Might have"
      expresa menor certeza: "If we had left earlier, we might have caught
      the train" (quizás lo habríamos cogido, pero no es seguro). "Would have"
      es la forma más neutra y directa.
  - question: ¿El third conditional siempre expresa arrepentimiento?
    answer: >-
      No necesariamente. También expresa alivio ("If he hadn't warned us,
...
1. If you _____ (invite) her, she _____ (come).
2. We _____ (win) the match if our best player _____ (not be) injured.
3. If he _____ (read) the contract carefully, he _____ (not sign) it.
4. She _____ (get) the promotion if she _____ (apply) earlier.
