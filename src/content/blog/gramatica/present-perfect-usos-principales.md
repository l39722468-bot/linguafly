...
faqs:
  - question: ¿El Present Perfect existe en español?
    answer: >-
      Sí, aunque no funciona exactamente igual. En español estándar usamos "he comido", "ha llegado"... pero en muchas regiones (México, Canarias, gran parte de Latinoamérica) se prefiere el pretérito indefinido: "comí", "llegó". En inglés no hay esa variación regional — el present perfect se usa de forma consistente en todas las variedades del idioma.
  - question: ¿Cuál es la diferencia entre "I ate" y "I have eaten"?
    answer: >-
      "I ate" (past simple) sitúa la acción en un momento concreto del pasado, terminado y sin conexión con el presente. "I have eaten" (present perfect) conecta el pasado con el presente: la acción ocurrió en algún momento de tu vida hasta ahora, o tiene relevancia en este momento. Añadir "already" o "just" refuerza esa conexión con el presente.
...
canonical: 'https://linguafly.app/blog/gramatica/present-perfect-usos-principales'
---
...
**Since** indica el punto de inicio (since 2018, since Monday, since I was a child).
**For** indica la duración (for ten years, for a long time, for ages).
...
|--------|----------|------------|
| I / You / We / They | have ('ve) | worked / seen / gone |
| He / She / It | has ('s) | worked / seen / gone |
...
- *I have* → *I've*
- *She has* → *She's* (ojo: también es contracción de *she is*)
- *They have* → *They've*
...
| Uso | Ejemplo | Clave |
|-----|---------|-------|
| Experiencia de vida | *I've been to Australia* | ever, never, before |
