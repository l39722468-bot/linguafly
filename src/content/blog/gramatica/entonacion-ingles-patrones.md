...
keywords:
  ...
  - entonacion ingles patrones
faqs:
  - question: ¿Qué es la entonación?
    answer: >-
      La entonación es la melodía del habla: el patrón de subidas y bajadas en el tono de la voz a lo largo de una frase. En inglés, la entonación no es solo una cuestión de elegancia; comunica significado gramatical (si algo es una pregunta o una afirmación), actitud (si estás siendo sarcástico, amable, sorprendido) y estructura del discurso (si has terminado de hablar o vas a continuar).
  - question: ¿El español y el inglés tienen la misma entonación?
    answer: >-
      Comparten algunos patrones (como la entonación descendente en afirmaciones) pero difieren en otros, especialmente en las preguntas. En español, las preguntas de sí/no también tienden a subir al final. En inglés, las preguntas con palabras interrogativas (Who, What, Where) bajan, lo que puede sorprender a hispanohablantes que esperan que "suene a pregunta" con un tono alto.
...
**Descendente en la tag** → el hablante está bastante seguro y busca confirmación:
*"It's a nice day, isn't it?"* ↘ (casi afirmando, solo confirmando)

**Ascendente en la tag** → el hablante tiene duda real y quiere información:
*"You've done this before, haven't you?"* ↗ (genuinamente preguntando)
...
Para entender la entonación en contexto con el ritmo general del inglés, consulta el artículo sobre el [ritmo del inglés como idioma stress-timed](/blog/gramatica/ritmo-ingles-stress-timed). Y para ver cómo la entonación se relaciona con el connected speech, el artículo sobre [connected speech en inglés](/blog/gramatica/connected-speech-ingles) explica cómo las palabras se encadenan en el habla real.
