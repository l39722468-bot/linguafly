...
keywords:
  ...
  - Inglés Australiano
  - Ingles Australiano
  - ingles australiano caracteristicas
faqs:
  - question: ¿El inglés australiano es más parecido al británico o al americano?
    answer: >-
      Histórica y fonológicamente más parecido al británico: comparte el sistema no rótico (la /r/ postvocálica no se pronuncia) y deriva del inglés que llevaron los colonos de las Islas Británicas. Pero en cuanto a vocales, el australiano ha desarrollado un sistema propio muy característico que lo distingue claramente del RP. En vocabulario y ortografía se acerca más al inglés británico.
  - question: ¿Hay variedades dentro del inglés australiano?
    answer: >-
      Sí. Los lingüistas identifican tres grandes variedades según el grado de "australianidad" del acento: Broad Australian (el más marcado, estereotipado internacionalmente), General Australian (el más neutro, el que usan los medios) y Cultivated Australian (el más cercano al RP, en retroceso). Las diferencias están principalmente en las vocales. Geográficamente, hay variación entre estados, pero es menor que en el inglés americano o el británico.
...
Si llegas con la consulta **pronunciacion ingles australiano**, el desarrollo está en los apartados siguientes, con ejemplos y el uso real, no como etiqueta suelta.
...
El artículo sobre [cómo entrenar el oído para entender diferentes acentos del inglés](/blog/gramatica/como-entrenar-oido-acentos-ingles) tiene una metodología más detallada para este proceso de adaptación.
