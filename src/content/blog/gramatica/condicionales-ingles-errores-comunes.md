...
category: gramatica
faqs:
  - question: ¿Es muy grave poner "will" después de "if"?
    answer: >-
      Es uno de los errores que más llaman la atención a los nativos y a los
      evaluadores. No impide la comprensión, pero marca claramente que la persona
      está traduciendo del español ("si lo haré"). En exámenes Cambridge, este
      error cuesta puntos en la banda de gramática. Vale la pena automatizar
      la regla.
  - question: ¿Por qué "would of" es un error?
    answer: >-
      Porque "would of" no existe en inglés. Lo que existe es "would have",
      que en inglés hablado se contrae a "would've". Al pronunciarse "would've"
      suena similar a "would of", y muchos hablantes no nativos (e incluso
      algunos nativos en escritura informal) lo escriben mal. Siempre escribe
      "would have" o "would've".
  - question: ¿Cómo sé si debo usar second o third conditional?
    answer: >-
      Pregúntate: ¿la condición es irreal ahora (presente/futuro) o es algo
      ...
      perfect / would have).
canonical: 'https://linguafly.app/blog/gramatica/condicionales-ingles-errores-comunes'
---
...
| Condicional | Tiempo | Estructura |
|---|---|---|
| Second | Presente / futuro | If + past simple / would + infinitivo |
| Third | Pasado que no ocurrió | If + past perfect / would have + participio |
