...
faqs:
  - question: ¿El "Southern accent" es un único acento o hay variedad dentro?
    answer: >-
      Hay mucha variedad dentro del "Sur". El acento de Nueva Orleans es diferente al de Texas, que es diferente al de Georgia, que es diferente al de las Appalachias. El "Southern American English" es una familia de dialectos con rasgos compartidos, no un acento monolítico. Los estudios dialectológicos identifican al menos media docena de variedades distintas dentro del sur de EEUU.
  - question: ¿El acento sureño americano es considerado "menos correcto" por otros americanos?
    answer: >-
      Históricamente, sí ha existido estigmatización del acento sureño en algunos contextos (asociado a bajo nivel educativo o bajo estatus social). Esta es una actitud lingüística irracional, no una evaluación objetiva: la lengua no tiene jerarquía de corrección inherente. Sin embargo, la realidad social es que el acento sureño marcado puede tener consecuencias en ciertos contextos profesionales en EEUU, lo que hace que muchos sureños desarrollen la capacidad de "neutralizar" su acento en situaciones formales.
...
Para una metodología más completa de adaptación a acentos, el artículo sobre [cómo entrenar el oído para entender acentos del inglés](/blog/gramatica/como-entrenar-oido-acentos-ingles) ofrece un protocolo paso a paso aplicable a cualquier variedad.
