...
faqs:
  - question: ¿Por qué entiendo bien el inglés americano pero no el australiano o el escocés?
    answer: >-
      Porque el oído aprende las categorías fonéticas a las que se expone. Si la mayor parte de tu input en inglés ha sido americano (a través de series, películas, canciones), tu sistema auditivo ha calibrado sus expectativas según ese acento. Cuando escuchas un acento diferente donde los mismos fonemas tienen realizaciones distintas (o donde hay fonemas que no existen en el americano), el cerebro no tiene las categorías para procesar esa información de forma eficiente. No es un problema de vocabulario ni de gramática: es de reajuste perceptivo.
  - question: ¿Cuánto tiempo lleva adaptarse a un acento nuevo?
    answer: >-
      Con exposición concentrada y activa, la comprensión de un acento nuevo mejora significativamente en 5-10 horas. Esto no significa dominio perfecto: significa que el nivel de esfuerzo necesario para seguir ese acento se reduce a algo manejable. La comprensión completa y fluida puede llevar semanas o meses, dependiendo de la diferencia entre el acento y la variedad que ya dominas.
...
1. Escucha sin subtítulos: intenta entender lo que puedas
2. Escucha de nuevo con subtítulos: observa la diferencia entre lo que esperabas oír y lo que realmente se dijo
3. Identifica 2-3 momentos específicos donde tu oído "se perdió": ¿qué sonido o qué patrón falló?
