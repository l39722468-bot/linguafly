---
title: 'Pronunciar -ed y -s en Inglés: Reglas y Ejemplos'
date: '2026-03-11'
...
keywords:
  - 'Pronunciar -ed y -s en Inglés: Reglas y Ejemplos'
...
faqs:
  - question: ¿Hay que memorizar todas las reglas de la "-ed" y la "-s"?
    answer: >-
      No exactamente. Las reglas se pueden memorizar de forma explícita al principio, pero con suficiente exposición al inglés auténtico el oído aprende a predecirlas automáticamente. La mayoría de los nativos no saben decirte la regla, pero la aplican sin pensar. El objetivo es ese estado: aplicación automática sin reflexión consciente.
  - question: ¿Los nativos siempre aplican estas reglas?
    answer: >-
      En el habla cuidadosa y lenta, sí. En el habla rápida, el connected speech introduce variaciones: la /d/ final puede asimilarse al sonido siguiente, la /s/ puede cambiar de calidad. Pero los patrones básicos se mantienen y son reconocibles. Aprender las reglas te da la base para después entender las variaciones.
...
Consultas como **como pronunciar pasado ingles terminacion ed**, **cómo pronunciar las terminaciones ed y s en inglés** o **reglas de pronunciación ed t d id con ejemplos** se responden aquí en prosa: el término aparece donde toca, no en una lista al pie.
...
| Terminación | Condición | Pronunciación | Ejemplo |
|---|---|---|---|
| -ed | Verbo termina en /t/ o /d/ | /ɪd/ (sílaba extra) | wanted, needed |
| -ed | Verbo termina en consonante sorda | /t/ (sin sílaba extra) | stopped, liked |
| -ed | Verbo termina en vocal o consonante sonora | /d/ (sin sílaba extra) | played, lived |
| -s | Palabra termina en sibilante | /ɪz/ (sílaba extra) | buses, watches |
| -s | Palabra termina en consonante sorda | /s/ | tops, cats |
| -s | Palabra termina en vocal o consonante sonora | /z/ | dogs, trees |
...
Para el contexto más amplio de la pronunciación de las reglas fonéticas del inglés, el artículo sobre [reglas de pronunciación del inglés: letras mudas, magic e y terminaciones](/blog/metodos/reglas-pronunciacion-ingles) cubre otras reglas frecuentes que complementan esta guía.
