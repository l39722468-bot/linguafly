...
faqs:
  - question: ¿Cuántos significados tiene "go off"?
    answer: >-
      Al menos cuatro muy distintos: explotar (una bomba), sonar (una alarma o un móvil), estropearse (la comida), y en inglés británico coloquial también significa dejar de gustarle algo a alguien. El contexto lo aclara siempre.
  - question: ¿"Go on" es lo mismo que "continue"?
    answer: >-
      En muchos contextos sí: "go on talking" es lo mismo que "continue talking". Pero go on tiene otros usos: puede significar que algo está pasando ("What's going on?"), puede ser una expresión para animar a alguien a que haga algo, o puede indicar que algo ocurre con frecuencia.
...
canonical: 'https://linguafly.app/blog/gramatica/phrasal-verbs-with-go'
---
