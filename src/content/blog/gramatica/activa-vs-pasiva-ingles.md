---
title: 'Voz Activa vs Pasiva en Inglés: Diferencias y Uso'
description: >-
...
readTime: 5 min
excerpt: >-
  No se trata de que una sea mejor que la otra. La activa y la pasiva tienen
  propósitos distintos y saber cuándo usar cada una es lo que define un nivel
  avanzado real en inglés.
keywords:
  - 'Voz Activa vs Pasiva en Inglés: Diferencias y Uso'
  ...
  - Voz Activa vs Pasiva en Inglés
  - Voz Activa vs Pasiva en Ingles
  - Voz Activa versus Pasiva en Inglés
...
category: gramatica
faqs:
  - question: ¿Es mejor usar la voz activa o la pasiva en inglés?
    answer: >-
      Depende completamente del contexto. La voz activa es más directa y dinámica,
      ideal para conversación, narrativa y textos informales. La pasiva es más
      objetiva e impersonal, y es la norma en textos científicos, académicos,
      periodísticos y documentos formales. La clave no es cuál es mejor, sino
      cuál sirve mejor al propósito de lo que escribes o dices.
  - question: ¿Por qué los libros de estilo dicen que hay que evitar la pasiva?
    answer: >-
      Ese consejo aplica principalmente a la escritura creativa y periodística
      informal, donde la pasiva puede hacer el texto pesado. Pero no aplica al
      inglés técnico, académico o científico, donde la pasiva es la opción
      estándar. El error no es usar la pasiva; es usarla donde no aporta nada.
  - question: ¿Cómo sé si un texto usa demasiada pasiva?
    answer: >-
      Si al leer tienes que hacer un esfuerzo para saber quién hace qué, probablemente
      hay demasiada pasiva o está mal usada. Una señal clara es cuando puedes
...
canonical: 'https://linguafly.app/blog/gramatica/activa-vs-pasiva-ingles'
---
...
|---|---|
| Conversación informal | Activa |
| Narrativa y ficción | Activa |
| El agente es importante | Activa |
| Instrucciones simples directas | Activa |
| Textos científicos/académicos | Pasiva |
| Noticias y periodismo formal | Pasiva |
| Agente desconocido o irrelevante | Pasiva |
| Quieres ser diplomático | Pasiva |
