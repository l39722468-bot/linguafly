...
keywords:
  ...
  - must have could have should have ingles
  - modal perfect ingles
  - verbos modales pasado ingles
  - especular pasado ingles
  - should have ingles arrepentimiento
  - could have ingles posibilidad
excerpt: >-
...
faqs:
  - question: ¿Cuál es la diferencia entre "must have" y "should have"?
    answer: >-
      "Must have" es una deducción — concluyes algo sobre el pasado a partir de la evidencia. "She must have missed the train" (deduzco que perdió el tren). "Should have" expresa lo que era correcto hacer pero no se hizo. "She should have taken the earlier train" (era lo más conveniente, pero no lo hizo). Una es conclusión lógica; la otra es juicio sobre lo que era correcto.
  - question: ¿"Could have" siempre implica que la acción no ocurrió?
    answer: >-
      No siempre. "Could have" puede indicar que la posibilidad existía (y puede o no haberse cumplido): "She could have taken a taxi" — tal vez lo hizo, tal vez no. En el tercer condicional, sí indica claramente que no ocurrió: "If I had applied earlier, I could have gotten the job." El contexto aclara si la acción ocurrió o no.
  - question: ¿"Might have" y "may have" son intercambiables?
    answer: >-
      En la práctica, sí en la mayoría de contextos. Ambos expresan posibilidad en el pasado con incertidumbre. "She might have left already" = "She may have left already." La diferencia de grado (might = menos probable) es teórica; en conversación real se usan casi como sinónimos para especulación pasada.
...
**Must not have cuando quieres decir "can't have":**
*Mustn't have* expresa que algo no debería haber ocurrido (obligación negativa en el pasado). Para deducción negativa, se usa *can't have*:
