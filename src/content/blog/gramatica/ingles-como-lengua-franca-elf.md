...
faqs:
  - question: ¿Qué es el inglés como lengua franca (ELF)?
    answer: >-
      El ELF (English as a Lingua Franca) es el inglés usado como medio de comunicación entre personas que no tienen el inglés como lengua materna. En una reunión donde un español habla con un coreano y un brasileño en inglés, están usando ELF. Este contexto de uso es, hoy en día, el más frecuente en el mundo: la mayor parte de las conversaciones en inglés ocurren entre no nativos.
  - question: ¿Debería aprender el ELF en lugar del inglés nativo?
    answer: >-
      No es tanto "en lugar de" como "tener en cuenta". El ELF no es una variedad que se aprenda específicamente como el RP o el General American: es más una forma de pensar sobre la comunicación. La investigación sobre ELF sí tiene implicaciones prácticas importantes: te ayuda a priorizar qué características de la pronunciación son realmente importantes para la comunicación internacional y cuáles son marcadores de acento nativo que no añaden claridad.
...
1. **Acento tónico correcto en las palabras**: invierte tiempo en saber dónde va el acento en el vocabulario que usas.
2. **Pronunciación clara de grupos consonánticos**: sin "e-" añadida al principio y sin simplificaciones que destruyan el cluster.
3. **Distinción de vocales largas y cortas**: especialmente en el vocabulario técnico que usas.
4. **Velocidad moderada y articulación clara**: en contextos internacionales, hablar más despacio y con más claridad no es "extranjero": es estratégico.
