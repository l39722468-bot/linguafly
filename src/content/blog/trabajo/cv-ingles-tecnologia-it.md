...
excerpt: >-
  ...
  vocabulario, la forma de describir logros y los detalles que un reclutador
...
category: trabajo
faqs:
  - question: '¿Debo usar "Curriculum Vitae", "CV" o "Resume"?'
    answer: 'Depende del país. En Reino Unido, Irlanda, Australia y gran parte de Europa se dice CV (y a veces Curriculum Vitae). En Estados Unidos y Canadá se usa "Resume" para documentos cortos (1-2 páginas) y "CV" se reserva para perfiles académicos muy detallados. Para perfiles de tecnología en EE. UU., casi siempre es "Resume".'
  - question: '¿Cuántas páginas debe tener un CV técnico en inglés?'
    answer: 'Regla general: una página si tienes menos de 7-8 años de experiencia, dos como máximo si tienes más. Para roles senior en arquitectura, tech leadership o investigación, dos páginas están aceptadas. Para juniors y devs con 3-5 años, una página contundente supera siempre a dos difusas.'
  - question: '¿Debo incluir foto en un CV técnico en inglés?'
    answer: 'En Reino Unido, Estados Unidos, Canadá, Irlanda y Australia: no. La foto puede llevar a sesgo y muchas empresas la retiran antes de enviarla al reclutador. En Alemania, Austria, España y partes de Latinoamérica sí es habitual. Si aplicas internacionalmente, quítala.'
  - question: '¿Qué son los ATS y cómo afectan a mi CV tech?'
...
laura.garcia@email.com · +34 612 345 678
...
| Construir | Optimizar | Liderar | Medir | Refactorizar |
|-----------|-----------|---------|-------|--------------|
| built | optimised | led | measured | refactored |
| designed | reduced | coordinated | benchmarked | migrated |
| developed | improved | managed | analysed | rewrote |
| implemented | streamlined | mentored | monitored | decomposed |
| delivered | accelerated | aligned | tracked | modularised |
| shipped | cut | directed | evaluated | redesigned |
...
Usa niveles oficiales (A2, B1, B2, C1, C2) o sistemas reconocidos (TOEFL 100, IELTS 7.5). Para saber qué examen te conviene, revisa la [comparativa entre IELTS y TOEFL para trabajo](/blog/trabajo/ielts-vs-toefl-trabajo) o los [mejores certificados de inglés en 2026](/blog/examenes/mejores-certificados-ingles-2026).
...
LAURA GARCÍA
Backend Engineer · Python · Go · AWS
laura@email.com · +34 612 345 678 · linkedin.com/in/lauragarcia · github.com/lauragarcia
Madrid, Spain · Open to remote (CET ± 2)
...
Con esta plantilla y estas reglas, tu CV técnico está al nivel de los que se envían desde Madrid, Berlín o Dublín para puestos con sueldos competitivos. El siguiente paso —preparar la entrevista— lo tienes cubierto en guías como [preparar la entrevista de trabajo en inglés](/blog/trabajo/preparar-entrevista-trabajo-ingles) y [técnica STAR para entrevistas](/blog/trabajo/tecnica-star-entrevista-ingles).
...
### CV y candidatura
- [CV en inglés: guía general](/blog/trabajo/cv-ingles)
...
- [Preparar la entrevista de trabajo en inglés](/blog/trabajo/preparar-entrevista-trabajo-ingles)
- [Técnica STAR para entrevistas en inglés](/blog/trabajo/tecnica-star-entrevista-ingles)
- [Preguntas difíciles en entrevistas en inglés](/blog/trabajo/preguntas-dificiles-entrevista-trabajo-ingles)
- [Entrevista virtual en inglés](/blog/trabajo/entrevista-virtual-ingles)

### Inglés técnico de trabajo
- [Inglés para ingenieros de software](/blog/trabajo/ingles-para-ingenieros-software)
- [Inglés para ingenieros (general)](/blog/trabajo/ingles-para-ingenieros)
- [Vocabulario de negocios en inglés profesional](/blog/trabajo/vocabulario-negocios-ingles-profesional)
