...
description: >-
  Guía práctica para liderar reuniones en inglés con profesionalidad: abrir y
  cerrar, dar la palabra, gestionar desacuerdos, reconducir el debate, tomar
  decisiones y hacer seguimiento, con frases listas para usar.
readTime: 12 min
excerpt: >-
...
category: trabajo
faqs:
  - question: '¿Qué nivel mínimo de inglés necesito para liderar reuniones?'
    answer: 'B2 sólido suele bastar si dominas las frases funcionales de reunión. Liderar requiere más vocabulario específico de facilitación (conectores, señalización de transiciones, frases de decisión) que profundidad conversacional. Con B1 fuerte + 30-40 frases memorizadas puedes dirigir reuniones rutinarias.'
  - question: '¿Cómo corto educadamente a alguien que habla demasiado?'
    answer: '"Sorry to interrupt, John, let’s park that for now and come back to it if we have time" o "Really interesting point, let’s capture it in the notes and move on so we stay on schedule". La clave es reconocer el punto, prometer volver y avanzar sin confrontar.'
  - question: '¿Es mejor usar "meeting" o "call" en inglés profesional?'
    answer: 'Meeting es término general. Call suele referirse a reuniones remotas breves (teléfono, videollamada). Sync se usa para reuniones cortas recurrentes (daily sync, weekly sync). Stand-up para reuniones de equipo ágil de 15 min. One-on-one (1:1) para reuniones individuales con tu manager.'
  - question: '¿Cómo gestiono desacuerdos en una reunión en inglés sin sonar agresivo?'
...
> | Owner | Action | Due |
> |-------|--------|-----|
> | David | Draft updated Q2 roadmap | Fri 25 Apr |
> | Sara | Align legal + finance on Frankfurt timing | Tue 29 Apr |
> | Tom | Kick off hiring for platform roles | Wed 23 Apr |
>
...
Para más plantillas y estructuras de email profesional, tenemos la guía de [estructura de email formal en inglés](/blog/trabajo/email-formal-ingles-estructura) y [plantillas de emails profesionales](/blog/trabajo/plantillas-emails-profesionales-ingles).
...
|-----------|-------------|
| Sync | Reunión corta recurrente |
| Stand-up | Reunión diaria de equipo ágil (15 min) |
| 1:1 (one-on-one) | Reunión individual con tu manager |
| Kick-off meeting | Reunión de arranque de proyecto |
| Retrospective / retro | Revisión de qué fue bien y mal |
| Circle back | Volver a un tema más tarde |
| Park it | Aparcar un tema para otra reunión |
| Deep dive | Entrar en detalle |
| Take it offline | Hablar fuera de la reunión |
| Ping me | Mándame un mensaje |
| Hard stop | Tengo que acabar a una hora fija |
| EOB / EOD | End of business / End of day (fin del día laboral) |
...
- [Presentaciones en inglés: estructura y frases](/blog/trabajo/como-hacer-presentaciones-en-ingles)
- [Inglés para networking en eventos internacionales](/blog/trabajo/ingles-networking-eventos-internacionales)
- [Vocabulario de negocios en inglés profesional](/blog/trabajo/vocabulario-negocios-ingles-profesional)

### Emails profesionales
- [Estructura de email formal en inglés](/blog/trabajo/email-formal-ingles-estructura)
- [Plantillas de emails profesionales en inglés](/blog/trabajo/plantillas-emails-profesionales-ingles)
- [Netiqueta del email en inglés](/blog/trabajo/netiqueta-email-ingles)
...
- [CV en inglés para tecnología e IT](/blog/trabajo/cv-ingles-tecnologia-it)
