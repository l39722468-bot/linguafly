...
title: "La IA no sustituye a un profesional colegiado"
description: >-
  La IA no sustituye a un profesional: sirve para preparar preguntas. La
  firma y la responsabilidad son de un titular, no de un chatbot de consumo.
readTime: 11 min
keywords:
...
faqs:
  ...
  - question: ¿Para qué sirve entonces un chatbot si no sustituye al profesional?
    answer: "Uso auxiliar: glosario, esquema de un documento que tú has leído, lista de preguntas para la visita, reescritura de un email que tú vas a revisar. El titular sigue siendo quien ve el expediente, te examina o firma. El modelo no ve tu cuerpo, no tiene tu carpeta fiscal y no se colegia."
  - question: ¿Cuándo tengo que parar y llamar a alguien de verdad?
    answer: "Cuando hay salud (síntomas, urgencia, tratamiento), dinero que se mueve o se declara, derechos (despido, contrato, denuncia, custodia) o un escrito que se presenta o se firma. Ahí el chat no cierra. Preparas preguntas o paras del todo. Si hay urgencia sanitaria, no abres el modelo: llamas al servicio que toque."
  - question: ¿Quién responde si sigo un consejo de la IA y sale mal?
    answer: "Tú, o tu organización, no el chatbot. El texto del modelo no es un dictamen ni una receta. No hay un colegiado al otro lado ni un seguro de esa prosa. La responsabilidad de un consejo de IA, en la práctica, es la de quien lo copia y actúa. Por eso no se copia en esos terrenos."
  - question: ¿Y si el texto del chat ‘suena’ a informe de un experto?
    answer: "El tono de informe no colegia a nadie. Está bien escrito y puede ser falso o inaplicable a tu fuero, tu comunidad o tu historia clínica. El criterio no se apaga porque el párrafo entre limpio. Lo usas como borrador de preguntas, no como pieza que presentas."
---
...
Esta página es el paraguas. Los límites *sanitarios* concretos (urgencia, síntomas, qué no pedir) están en [consejo médico: el límite claro](/blog/inteligencia-artificial/consejo-medico-el-limite-claro). Los *jurídicos* (contrato, fuero, qué no firmar) están en [consejo jurídico: el límite claro](/blog/inteligencia-artificial/consejo-juridico-el-limite-claro). Aquí no se copian esas listas. Aquí: **herramienta, no titular**; cuándo parar (dinero, salud, derechos, un escrito que se firma); y quién carga con el error.

Qué es el programa, sin ciencia ficción: [qué es la inteligencia artificial (sin ciencia ficción)](/blog/inteligencia-artificial/que-es-la-inteligencia-artificial-sin-ciencia-ficcion). Lo que sigue asume que ya no lo tratas como oráculo.
...
1. **Define el oficio al que vas.** Médico, letrado, gestor, arquitecto. El chat no elige el oficio por ti si el tema cruza (un despido con baja: no lo resuelve un párrafo).
2. **Recorta el texto.** Sin identidad, sin menores, sin cuentas. Si no se puede recortar, no pegas: llevas el papel a la visita.
3. **Una tarea:** glosario, o lista de preguntas, o esquema de lo que *tú* ya has leído. No “dime qué hago”.
4. **Prohibición:** no diagnostiques, no dictamines, no inventes preceptos ni dosis ni plazos de presentación.
5. **Lee la salida como borrador de preguntas**, no como respuesta. Tacha lo que no vas a poder defender. El tono de informe no cuenta; eso es [confianza excesiva: el texto suena bien](/blog/inteligencia-artificial/confianza-excesiva-el-texto-suena-bien).
6. **Lleva el original a la persona.** El chat no viaja como anexo de autoridad. “Lo he consultado con una IA” no es un argumento en la consulta ni en el despacho.
...
1. **Salud.** Síntomas, “¿es grave?”, fotos clínicas, analíticas, medicación, salud mental en crisis, embarazo, menores enfermos. Urgencia: teléfono o servicio sanitario, no el modelo. El satélite médico desarrolla el borde. Aquí: paras.
2. **Dinero.** Declaraciones, retenciones, “¿puedo no declarar esto?”, inversiones, “¿este banco es seguro?”, cantidades que se transfieren porque el chat “lo ha visto claro”. Gestor, entidad, profesional. No el párrafo.
3. **Derechos.** Despido, sanción, contrato de alquiler o de trabajo que vas a firmar, denuncia, custodia, extranjería, un plazo administrativo que si se pasa duele. Letrado o el servicio que corresponda. El chat no paraliza plazos.
4. **Un escrito que se firma o se presenta.** Recurso, demanda, alegaciones, visado, certificado que sale con tu nombre, consentimiento informado, alta, baja, modelo tributario. El texto del chat no se presenta. Se redacta, se revisa y se firma en el recinto profesional, o lo redactas tú sabiendo que *tú* firmas, no el modelo.
...
1. **La IA no sustituye a un profesional.** Auxiliar, no acto.
2. **ChatGPT no es médico, abogado ni gestor.** Ningún chat de consumo lo es.
3. Paras si hay **salud, dinero, derechos o un escrito que se firma o se presenta.**
4. La **responsabilidad de un consejo de IA** es de quien lo copia y actúa. El titular sigue siendo el titular.
