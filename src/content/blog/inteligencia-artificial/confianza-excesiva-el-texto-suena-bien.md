...
title: "Confianza excesiva: el texto suena bien"
description: >-
  Confianza excesiva en ChatGPT: el texto está bien escrito y aun así puede
  ser falso. El tono seguro no apaga el criterio: lee con sospecha útil.
readTime: 11 min
keywords:
...
faqs:
  ...
  - question: ¿El tono seguro de un modelo significa que el dato es cierto?
    answer: "No. El tono seguro de un modelo es un estilo: frases cerradas, listas de tres, cero tartamudeo. No es un medidor de certeza. Si hay una cifra, una fecha o una promesa, la pruebas fuera del chat o contra tu original. El ‘por supuesto’ no cuenta."
  - question: ¿Cómo leer con sospecha útil sin volverme paranoico?
    answer: "No relés el ensayo buscando mala fe. Pasa una vez: plazos, importes, nombres, motivos que no estaban en tu texto, fuentes. Lo que no puedas señalar en el original o en la web oficial, fuera. El resto (tono, orden, cortesía) se puede aprovechar."
  - question: ¿Qué hago si el email reescrito ha metido un plazo que yo no dije?
    answer: "No lo envías. En el siguiente mensaje: ‘Ese viernes no está en el original. Quítalo. No pongas otro plazo.’ Vuelves a leer contra tu borrador. Si el chat insiste en una fecha, la copias tú a mano desde el correo o el calendario, no desde el modelo."
  - question: ¿Sirve preguntarle al propio chat si está seguro?
    answer: "Sirve poco. Puede responder que sí, que está muy seguro, y repetir el error con más adornos. La prueba no es otro párrafo del mismo programa. Es tu original, un calendario o una web que emite el dato."
---
...
Este artículo no es el método largo de contrastar cifras y URLs: eso está en [cómo comprobar si una respuesta de IA es fiable](/blog/inteligencia-artificial/como-comprobar-si-una-respuesta-de-ia-es-fiable). Tampoco explica el motor de las alucinaciones: eso está en [por qué un chatbot se inventa datos](/blog/inteligencia-artificial/por-que-un-chatbot-se-inventa-datos). Aquí el trabajo es otro: **no apagar el criterio** porque la prosa fluye. El ejemplo que importa es un email pulido con un plazo que nadie te dio.
...
No hace falta antropomorfismo para caer. No hace falta creer que “piensa”. Basta leer en diagonal un texto que parece ya enviado. Si te habla como persona y encima te fías del tono, el problema se duplica; eso se trata aparte en [antropomorfismo: no es tu amigo](/blog/inteligencia-artificial/antropomorfismo-no-es-tu-amigo). Aquí: la fluidez.
...
Menos “profesional” en el sentido de folleto. Más cierto. Eso envías. Si más tarde *tú* decides un viernes, lo escribes tú, mirando el calendario, no el chat.
