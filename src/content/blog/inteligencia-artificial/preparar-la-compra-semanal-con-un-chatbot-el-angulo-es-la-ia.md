...
title: "Preparar la compra semanal con un chatbot (el ángulo es la IA)"
description: >-
  Lista de la compra con ChatGPT: de un menú tuyo a una lista del súper.
  Aquí manda el prompt, no el hábito de comprar. Tú das el menú y lo que
  hay en la nevera.
readTime: 11 min
keywords:
...
faqs:
  - question: ¿Puedo pedirle a ChatGPT la lista de la compra de la semana?
    answer: "Sí, si tú pegas el menú y lo que ya hay en nevera y despensa. El modelo agrupa ingredientes y no debería inventar una dieta. La lista se revisa. El hábito de no comprar ‘por si acaso’ no lo hace el chat: lo haces tú en el súper."
  - question: ¿ChatGPT me puede inventar el menú y la lista a la vez?
    answer: "Puede, y suele salirte un meal prep de influencer: cinco salsas, kale y un horno que no tienes. No es este artículo. Tú fijas tres cenas que ya sabes hacer. El chat pasa eso a lista. Si no hay menú tuyo, no hay prompt de compra que sirva."
  - question: ¿Cómo paso recetas a ingredientes sin que se invente botes?
    answer: "Pegas la receta o los platos con cantidades vagas (‘lentejas para 3’, ‘salteado de pollo’). Pides tabla: ingrediente, cantidad, si ya lo tengo. Prohíbes añadir ‘esenciales de despensa’ que no hayas pedido. Contrastas con lo que hay en casa antes de salir."
  - question: ¿Puedo pegar la tarjeta de fidelización o el ticket con mis datos?
    answer: "No. Ni número de tarjeta Club, ni código de barras de socio, ni ticket con NIF si no hace falta. El modelo no necesita tu cuenta para agrupar tomates y garbanzos. Recorta. La privacidad no se relaja porque sea ‘solo la compra’."
  - question: ¿Esto sustituye el artículo de la lista semanal sencilla?
    answer: "No. Allí está el hábito: plan, inventario, bloques del súper, no comprar por si acaso. Aquí está el trabajo del chatbot: de tu menú a una lista agrupada. Los dos se usan. El prompt no te enseña a no llenar el carro de queso de oferta."
---
...
La regla es la de [privacidad al usar IA: qué no pegar nunca](/blog/inteligencia-artificial/privacidad-al-usar-ia-que-no-pegar-nunca). La compra no es una excepción porque sea casera. Si el modelo no necesita el dato para agrupar tomates, fuera.
