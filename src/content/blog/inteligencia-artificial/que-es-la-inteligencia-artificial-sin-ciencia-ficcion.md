...
title: "Qué es la inteligencia artificial (sin ciencia ficción)"
description: >-
  Qué es la inteligencia artificial en la práctica: para qué sirve, qué no
  hace y cómo usarla el primer día, sin robots, mitos ni ciencia ficción.
readTime: 11 min
keywords:
...
faqs:
  ...
  - question: ¿Qué diferencia hay entre IA y un chatbot?
    answer: "La IA es el campo y el modelo. El chatbot es la ventana de chat donde escribes. Puedes usar IA sin chat (filtros de spam, traducción en el móvil). Un chatbot es una forma de hablar con un modelo de lenguaje, no el único tipo de IA."
  - question: ¿Qué significa IA generativa?
    answer: "Que el sistema produce texto, imagen o audio nuevo a partir de tu petición, en vez de solo clasificar o buscar. Lo que genera puede parecer correcto y estar inventado. Por eso se comprueba, no se copia a ciegas."
  - question: ¿Para qué sirve la IA el primer día si no soy técnico?
    answer: "Para una tarea acotada que ya sabes hacer a medias: resumir un texto tuyo, pedir un esquema, reescribir un párrafo más corto. No para decidir un diagnóstico, firmar un contrato ni inventar fuentes. Empieza con un documento que puedas verificar."
  - question: ¿La inteligencia artificial para principiantes exige pagar?
    answer: "No el primer día. Las versiones gratuitas de los chatbots bastan para aprender el gesto: pedir, leer, corregir, parar. Pagas después si el límite de uso o el tamaño de documento te cortan una tarea real, no porque el plan de pago te vuelva experto."
---
...
Tres piezas que sí importan:

1. **Entrada.** Lo que tú escribes, pegas o subes. Un párrafo, una pregunta, un archivo. Si la entrada es vaga, la salida será vaga. Si la entrada incluye un DNI, el sistema ha visto un DNI. Eso se trata en [privacidad al usar IA: qué no pegar nunca](/blog/inteligencia-artificial/privacidad-al-usar-ia-que-no-pegar-nunca).
...
3. **Salida.** Texto, lista, tabla, imagen. Es un borrador. Hasta que tú lo compruebas, no es un hecho.
...
- **Inteligencia artificial** es el nombre amplio: sistemas que aprenden patrones y automatizan un juicio estadístico. El filtro antispam de tu correo es IA. El reconocimiento de cara para desbloquear el móvil es IA. La recomendación de una serie es IA. Casi ninguna de esas cosas es un chat.
- **Chatbot de IA** es una interfaz: tú escribes, el modelo contesta en prosa. Encima suele haber un modelo de lenguaje grande. Eso es lo que la gente llama “usar IA” en 2026.
- **IA generativa** (más abajo) es el tipo que *produce* contenido nuevo. Un clasificador de spam no escribe un poema. Un chatbot sí escribe un email.
...
1. Si tu problema es **clasificar** (¿esto es una factura o un contrato?), a veces basta una regla o una carpeta. No hace falta un ensayo de 800 palabras del chatbot.
2. Si tu problema es **redactar o resumir**, el chatbot encaja. Aun así, el texto de partida tiene que ser tuyo o público, y la salida se revisa.
3. Si tu problema es **buscar un dato** (horario de un tren, artículo del BOE), un buscador o la web oficial gana. El chatbot puede inventar el número de disposición con toda la seriedad del mundo.
...
1. **Puede alucinar.** Inventa un autor, un precepto, una cita, un porcentaje. El estilo es fluido, así que el invento se lee bien. La fluidez no es una prueba.
...
- Le pides “escribe”, “resume”, “traduce”, “haz una tabla”, “propón un esquema”.
...
- Resumir un documento que ya leíste por encima y quieres un esquema para volver a él.
- Reescribir un párrafo más corto o más formal, sin cambiar los hechos.
- Pasar notas desordenadas a una lista de tareas. Las tareas las priorizas tú.
- Pedir preguntas de comprensión sobre un texto de estudio (el examen lo haces tú).
- Traducir un cartel o un menú y luego mirar si el plato tiene sentido.
- Preparar un email tenso: tres versiones, tú eliges y recortas.
...
- “¿Me opero?” “¿Demando?” “¿Invierto aquí?”
- Inventar bibliografía para un TFG.
- Sustituir la lectura del contrato que vas a firmar.
- Decidir si un lunar es grave a partir de una foto.
- Pedir un plan de entrenamiento o una dieta como si fuera una consulta clínica. Hay otros verticales de esta revista para hábitos; la IA no es el médico ni el entrenador que te ha visto.
...
3. El primer día: **una tarea, un texto comprobable, cero datos que no pegarías en un post público.**

La ciencia ficción puede esperar. El PDF de esta tarde no.
