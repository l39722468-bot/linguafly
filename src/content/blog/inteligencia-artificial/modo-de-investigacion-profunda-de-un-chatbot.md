...
title: "Modo de investigación profunda de un chatbot"
description: >-
  Deep Research de un chatbot: un informe largo con muchas fuentes. Cada
  cita se abre igual. No es un analista senior. Cuándo el modo lento ayuda.
readTime: 11 min
keywords:
...
faqs:
  - question: ¿Qué es el Deep Research de un chatbot?
    answer: "Un modo lento: el producto navega, tarda minutos y devuelve un informe largo con citas (ChatGPT Deep Research, Gemini en investigación larga; el nombre se mueve). Cada cita se abre igual que en un chat corto. No es un analista senior. No es Perplexity ni ChatGPT Search."
  - question: ¿Cuándo ayuda un modo lento de investigación?
    answer: "Cuando la pregunta es ancha, hay muchos emisores posibles y te vale un mapa de candidatos para ir abriendo. No ayuda si ya conoces la URL, si el dato es uno (un plazo, un horario) o si en diez minutos puedes abrir tres páginas oficiales. Ahí un informe de treinta fuentes es ruido."
  - question: ¿Puedo fiarme de las citas del informe?
    answer: "No sin clic. Seguir comprobando citas: si el enlace no carga, redirige o el párrafo no dice eso, esa frase cae. El tono de dossier no cuenta. Cuarenta chips no son cuarenta hechos. El método de abrir uno a uno está en el artículo de pedir fuentes."
  - question: ¿ChatGPT Deep Research sustituye a un analista?
    answer: "No. No un analista senior: no tiene tu encargo, no firma, no conoce los documentos internos que no le has dado, no asume responsabilidad. Ordena un barrido público. Tú recortas, tacha y decides. Un cliente o un jefe no reciben el PDF del chat sin tu lectura."
  - question: ¿Es lo mismo que Perplexity o que ChatGPT Search?
    answer: "No. Perplexity es una búsqueda rápida con citas a la vista. ChatGPT Search es el recinto de buscar dentro del chat, frente a Google. Deep Research es el informe largo y lento. En los tres sales a la página. No mezcles las tres listas de enlaces en la misma hora."
---
...
Esta página es el informe largo. No es [Perplexity: buscar con citas a la vista](/blog/inteligencia-artificial/perplexity-buscar-con-citas-a-la-vista) (otro producto, búsqueda rápida). No es [ChatGPT Search frente a Google](/blog/inteligencia-artificial/chatgpt-search-frente-a-google) (otro recinto, otro SERP). El método de abrir cada fuente está en [pedir fuentes y verificarlas una a una](/blog/inteligencia-artificial/pedir-fuentes-y-verificarlas-una-a-una). Un folio *antes* de disparar el modo lento: [un brief de investigación de una página](/blog/inteligencia-artificial/un-brief-de-investigacion-de-una-pagina). Aquí no se reescriben. Aquí: el modo lento, el informe, el clic igual.
...
|---|---|
| URL que ya conoces | La URL. Listo. |
| Una pregunta, citas a la vista, quince minutos | Perplexity o Search, y abres. Otras páginas. |
| Mapa, BOE que ya sabes buscar, titular de ahora | Google (o el emisor). |
| Pregunta ancha, muchos emisores, tiempo | Modo lento, luego las mismas pestañas. |
| Folio para un colega mañana | Brief de una página. El modo lento puede *seguir* al brief, no sustituirlo. |
...
7. **Reescribes tú** las diez líneas útiles, con URLs que *tú* abriste. El informe se queda en el cajón.
