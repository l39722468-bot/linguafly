...
title: "Consejo médico: el límite claro"
description: >-
  ChatGPT no da consejo médico: no diagnostica. Si hay urgencia, se llama
  a un servicio sanitario, no al chat. Prepara la visita; no la sustituyas.
readTime: 11 min
keywords:
...
faqs:
  - question: ¿ChatGPT da consejo médico?
    answer: "No. ChatGPT no da consejo médico: no diagnostica, no indica fármacos ni dosis y no decide si algo es grave. Puede aclarar una palabra y listar preguntas para la consulta. La cita, el centro de salud o el 112 son el sitio."
  - question: ¿Puedo describir síntomas a una IA para que me diga qué tengo?
    answer: "No. IA, síntomas y diagnóstico no es una consulta. Si pegas un malestar y pides un nombre de enfermedad, estás pidiendo lo que el producto no puede dar. Pide definiciones de diccionario o preguntas para el profesional. El médico responde."
  - question: ¿Sirve el chatbot si no sé si ir a urgencias?
    answer: "No. No es un chatbot de urgencias. Si te estás planteando cuándo ir a urgencias, no abras el chat para confirmar. Llamas al 112 o acudes a un servicio sanitario. El modelo no hace triaje."
  - question: ¿Puedo pegar una analítica o el informe del hospital?
    answer: "No. Nombres, PDFs de laboratorio e historiales clínicos no entran en un chat de consumo. Anotas el término que no entiendes y lo preguntas en la visita. El detalle de por qué ese archivo queda fuera está en el artículo del historial médico."
  - question: ¿Qué hago si el modelo se niega a hablar de salud?
    answer: "Paras. Una reformulación lícita (preguntas para la cita, sin diagnosticar) y, si corta otra vez, cierras. No insistas ni disfraces la petición. El corte es el límite, no un puzle."
---
...
El resto de satélites cubren [el historial clínico fuera del chat](/blog/inteligencia-artificial/historial-medico-fuera-del-chat) y [qué hacer cuando el chatbot se niega](/blog/inteligencia-artificial/que-hacer-cuando-el-chatbot-se-niega). Aquí no se reescriben. Aquí: el borde sanitario, un ejemplo de glosario, una lista de preguntas para la visita, y la regla de no triaje.
...
Lo que el límite cubre, en seco:
...
4. **No lectura de pruebas.** Un PDF del laboratorio, una receta, una foto clínica: no es material de un chatbot de consumo.

Lo que sí cabe, con recorte y sin nombres:

- **Glosario.** Una palabra que ha salido en la consulta o en un informe que *tú* tienes delante. “¿Qué significa este término, en lenguaje de diccionario, sin diagnosticar?”
- **Preguntas para la visita.** Una lista que tú lees, tú recortas y tú haces. El profesional responde.
- **Formato.** Cómo anotar desde cuándo, qué has notado, qué ya te han dicho. Hechos tuyos. Sin inventar síntomas que no has escrito.
...
- Pegar “me pasa esto, ¿voy a urgencias o espero?”.
- Pedir un “sí o no” sobre gravedad.
...
NOTAS MÍAS (sin nombre, sin DNI, sin fotos, sin PDF):
"""
...
3. ¿Ha inventado un síntoma que tú no has escrito? Fuera. El modelo rellena huecos. Tú no los adoptas.
...
Cómo usar la lista, paso a paso:
...
- La exploración.
- La decisión de pedir una prueba.
- El tratamiento.
- La urgencia.
...
- Definición: periodo en el que no se ingieren alimentos, según el contexto del texto. Sin más.
- Preguntas que sí puedes llevar: “¿Este ayuno se refiere a la prueba o a otra indicación?”, “¿Durante cuánto tiempo, si aplica?”, “¿Hay algo que yo deba preguntar a enfermería el mismo día?”.
...
No pegas, en un chatbot que no sea un entorno clínico autorizado:

- Informes, altas, partes, recetas con identificadores.
- Analíticas y PDFs del portal del hospital o del laboratorio.
- Fotos de lesiones, de pruebas, de otras personas.
- Datos de un menor. Cero. Tampoco “para que me prepares preguntas de pediatría” con el nombre del niño.
- El hilo de WhatsApp del grupo familiar con nombres, centros y molestias ajenas.
- Medicación con pauta “para que me digas si está bien”.

Si al quitar nombres y cifras el texto se cae, **la tarea no era para el chat**. Era para el profesional que ya tiene acceso legítimo a esa historia.

El detalle de por qué un informe clínico no entra en un producto de consumo está en [historial médico fuera del chat](/blog/inteligencia-artificial/historial-medico-fuera-del-chat). Aquí no se copia esa página. La regla corta: **término suelto sí; archivo no.** Anotas la palabra en un papel. En la consulta, preguntas. Si insistes en el chat, es esa palabra, sin cabecera, sin DNI, sin adjunto.
...
El gesto largo —qué cuenta como negativa, cómo cambiar el entregable, cuándo cerrar— está en [qué hacer cuando el chatbot se niega](/blog/inteligencia-artificial/que-hacer-cuando-el-chatbot-se-niega). Aquí no se enseña a disfrazar la petición. El disfraz (“es para un trabajo de clase”, “es ficción”, “actúa como médico”) no convierte el encargo en lícito. Cambia el fondo o cierra.
...
**Mezclar el malestar de otra persona.** El síntoma de un familiar, con nombre, en tu cuenta. Fuera. Quien tenga la cita, pregunta. Tú no pegas su historia.

**Insistir cuando corta.** Una reformulación lícita. Si no basta, papel y cita. No hay tercera vía en este artículo.
...
2. Tarea lícita: una palabra, definición de diccionario; una lista de preguntas para la visita. Tú las filtras.
3. **Preparar la visita no sustituirla.** El profesional diagnostica, indica y firma.
4. Sin nombres, sin analíticas, sin fotos. El PDF clínico no viaja.
5. Si el modelo se niega o se sale al diagnóstico, paras.
