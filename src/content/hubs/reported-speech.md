...
1.  **Direct Speech (Estilo Directo):** Repetimos las palabras exactas entre comillas.
    *   *Example: She said, "I am happy."*
2.  **Reported Speech (Estilo Indirecto):** Explicamos lo que la persona dijo, adaptando la gramática para reflejar que estamos hablando del pasado.
...
1.  **Verbo + (that):** *Explain, admit, complain, deny, insist, promise.*
    *   *He admitted that he had made a mistake.*
2.  **Verbo + Alguien + to-infinitive:** *Advise, ask, invite, order, remind, warn.*
    *   *She reminded me to call my mother.*
3.  **Verbo + Gerundio (-ing):** *Suggest, recommend, deny, admit.*
...
1.  El salto atrás del verbo (backshift).
2.  El cambio de pronombres.
3.  La expresión de tiempo (yesterday → the day before).

## Ejercicios Prácticos Recomendados

Para dominar el estilo indirecto, te recomendamos practicar con situaciones reales:
1.  Escucha una entrevista y trata de resumir lo que el entrevistado dijo usando verbos como *claimed, argued* o *stated*.
2.  Escribe un pequeño informe sobre una reunión de trabajo.
3.  Busca "reported speech questions pdf" en nuestro blog para descargar materiales adicionales.
