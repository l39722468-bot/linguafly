...
*   **UK:** Col**our**, Hon**our**, Lab**our**.
*   **US:** Col**or**, Hon**or**, Lab**or**.

### Terminación -re vs -er
*   **UK:** Cent**re**, Heat**re**, Met**re**.
*   **US:** Cent**er**, Theat**er**, Met**er**.

### Terminación -ise vs -ize
*   **UK:** Organ**ise**, Real**ise**.
*   **US:** Organ**ize**, Real**ize** (en US siempre es con 'z', en UK ambas se aceptan pero se prefiere 's').

### Consonantes Dobles
*   **UK:** Trave**ll**ed, Cance**ll**ing.
*   **US:** Trave**l**ed, Cance**l**ing.
...
1.  **Sustantivos Colectivos:** En UK puedes decir *"The team ARE playing"* (el equipo son/están jugando). En US se prefiere el singular: *"The team IS playing"*.
2.  **Verbos Irregulares:** Algunos verbos son irregulares en UK y regulares en US.
    *   *Learn:* UK (learnt) / US (learned).
    *   *Dream:* UK (dreamt) / US (dreamed).
3.  **Uso de "Get":** En US el participio es *gotten* (*I have gotten used to it*). En UK es simplemente *got*.
