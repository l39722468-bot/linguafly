...
export const A1_LEXICON: LexicalItem[] = [
  ...
  // 'a' (artículo) no se traduce por petición: "las a sueltas no deben estar traducidas"
  ...
  { lemma: 'have breakfast', pos: 'verb', translation: 'desayunar', i_es: 'desayuno', he_she_es: 'desayuna', tags: ['routine', 'morning_activity', 'A1'], unit: 8 },
  { lemma: 'seven o\'clock', pos: 'noun', translation: 'las siete en punto', tags: ['time', 'routine', 'A1'], unit: 8 },
  { lemma: 'half past seven', pos: 'noun', translation: 'las siete y media', tags: ['time', 'routine', 'A1'], unit: 8 },
  { lemma: 'half past eight', pos: 'noun', translation: 'las ocho y media', tags: ['time', 'routine', 'A1'], unit: 8 },
  { lemma: 'ten o\'clock', pos: 'noun', translation: 'las diez en punto', tags: ['time', 'routine', 'A1'], unit: 8 },
  { lemma: 'get up', pos: 'verb', translation: 'levantarse', i_es: 'me levanto', he_she_es: 'se levanta', tags: ['routine', 'morning_activity', 'reflexive', 'A1'], unit: 8 },
  { lemma: 'gets up', pos: 'verb', translation: 'se levanta', tags: ['routine', 'morning_activity', 'A1'], unit: 8 },
  { lemma: 'goes', pos: 'verb', translation: 'va', tags: ['routine', 'action', 'A1'], unit: 8 },
  { lemma: 'have', pos: 'verb', translation: 'tener', i_es: 'tengo', he_she_es: 'tiene', tags: ['routine', 'action', 'A1'], unit: 8 },
  { lemma: 'do', pos: 'verb', translation: 'hacer (auxiliar en preguntas)', i_es: 'hago', tags: ['grammar', 'A1'], unit: 8 },
  { lemma: 'breakfast', pos: 'noun', translation: 'desayuno', gender_es: 'm', tags: ['routine', 'food', 'A1'], unit: 8 },
  { lemma: 'going', pos: 'verb', translation: 'yendo / ir (gerundio)', tags: ['grammar', 'A1'], unit: 8 },
  { lemma: 'having', pos: 'verb', translation: 'teniendo / tener (gerundio)', tags: ['grammar', 'A1'], unit: 8 },
  ...
  { lemma: 'go to bed', pos: 'verb', translation: 'irse a la cama / acostarse', i_es: 'me acuesto', he_she_es: 'se acuesta', tags: ['routine', 'night_activity', 'A1'], unit: 8 },
  { lemma: "o'clock", pos: 'adverb', translation: 'en punto (hora)', tags: ['time', 'routine', 'A1'], unit: 8 },
