/**
 * C1 Unit 13 — Travel and Cultural Exchange
 * Module 2: Society and Knowledge
 * Grammar: Participle clauses as adverbial modifiers
 */

import { Exercise } from '@/lib/exercise-generator';

export const UNIT_TITLE = 'Travel and Cultural Exchange';

export const UNIT_13_EXERCISES: Exercise[] = [
{
    id: 'c1-u13-g1', type: 'multiple-choice', level: 'C1', topic: 'participle-clauses', difficulty: 'hard',
    content: { title: '[[Grammar|Gramática]]: [[Participle Clauses|Oraciones de participio]]', instructions: 'Choose the correct participle clause.',
      questions: [{ question: 'She arrived in Tokyo. She had never been to Japan before. Combine using a participle clause:', options: ["[[Having never visited Japan before, she arrived in Tokyo with a mixture of excitement and apprehension.|Nunca habiendo visitado Japón antes, llegó a Tokio con una mezcla de emoción y aprensión.]]", "[[Never visited Japan before, she felt excited when arrived in Tokyo.|Nunca visitó Japón antes, se sintió emocionada cuando llegó a Tokio.]]", "[[Having been never in Japan before, she was arriving in Tokyo with excitement.|Nunca habiendo estado en Japón antes, estaba llegando a Tokio con emoción.]]"], correctAnswer: 0, explanation: '"Having + past participle" = perfect participle clause indicating an action completed before the main clause.' }] },
    topicName: 'Grammar',
  },
{
    id: 'c1-u13-g2', type: 'fill-blank', level: 'C1', topic: 'participle-clauses', difficulty: 'hard',
    content: { title: '[[Grammar|Gramática]]: [[Participle Clauses|Oraciones de participio]]', instructions: 'Complete with the correct participle form.',
      questions: [{ question: '_______ extensively in Southeast Asia, he understood the cultural nuances that foreign visitors often misinterpret.', options: ['[[Having travelled|Habiendo viajado]]', '[[Travelled|Viajado]]', '[[Being travelled|Siendo viajado]]'], correctAnswer: 'Having travelled', acceptableAnswers: ['Having travelled', 'Having traveled'], explanation: '"Having travelled" = perfect active participle clause explaining the reason for his understanding.' }] },
    topicName: 'Grammar',
  },
{
    id: 'c1-u13-g3', type: 'multiple-choice', level: 'C1', topic: 'participle-clauses', difficulty: 'hard',
    content: { title: '[[Grammar|Gramática]]: [[Participle Clauses|Oraciones de participio]]', instructions: 'Choose the correct option.',
      questions: [{ question: 'The travellers were exhausted. Despite this, they continued to explore the city. Choose the best sentence:', options: ['[[Exhausted though they were, the travellers continued to explore the city.|Aunque estaban agotados, los viajeros continuaron explorando la ciudad.]]', '[[Being exhausted, the travellers continued to explore the city despite.|A pesar de estar agotados, los viajeros continuaron explorando la ciudad.]]', '[[Having been exhausted, the travellers were unable to continue exploring the city.|Tras haber estado agotados, los viajeros no pudieron continuar explorando la ciudad.]]'], correctAnswer: 0, explanation: '"Exhausted though they were" = inverted concessive participle clause (adjective + though + subject + be).' }] },
    topicName: 'Grammar',
  },
{
...
{
    id: 'c1-u13-v2', type: 'fill-blank', level: 'C1', topic: 'travel-vocabulary', difficulty: 'hard',
    content: { title: '[[Vocabulary|Vocabulario]]: [[Travel and Culture|Viaje y cultura]]', instructions: 'Complete the sentence.',
      questions: [{ question: 'Spending a year in a foreign country often leads to _______ — a gradual process of adopting the values, practices and customs of the host culture.', options: ['[[acculturation|aculturación]]', '[[assimilation|asimilación]]', '[[integration|integración]]'], correctAnswer: 'acculturation', acceptableAnswers: ['acculturation'], explanation: '"Acculturation" = the process of adapting to and adopting elements of a new culture while retaining aspects of one\'s own.' }] },
    topicName: 'Vocabulary',
  },
{
    id: 'c1-u13-v3', type: 'multiple-choice', level: 'C1', topic: 'travel-vocabulary', difficulty: 'hard',
    content: { title: '[[Vocabulary|Vocabulario]]: [[Travel and Culture|Viaje y cultura]]', instructions: 'Choose the best collocation.',
      questions: [{ question: 'The guide warned tourists to be culturally _______ and avoid behaviours that might be considered disrespectful in the local context.', options: ['[[sensitive|sensible]]', '[[conscious|consciente]]', '[[alert|alerta]]'], correctAnswer: 0, explanation: '"Culturally sensitive" = aware of and respectful towards cultural differences. A fixed and high-frequency collocation.' }] },
    topicName: 'Vocabulary',
  },
{
...
{
    id: 'c1-u13-r2', type: 'multiple-choice', level: 'C1', topic: 'travel-reading', difficulty: 'hard',
    content: { title: '[[Reading|Lectura]]: [[Cultural Exchange|Intercambio cultural]]', instructions: 'Choose the best answer.',
      questions: [{ question: 'Text: "A recurring critique of gap year travel is that it can perpetuate a paternalistic relationship between the traveller and the host community — one in which the visitor\'s sense of personal development is placed above the genuine needs and agency of local people."\n\nWhat does "paternalistic" imply in this context?', options: ['[[a relationship based on mutual respect and equal contribution between the traveller and the host community|una relación basada en el respeto mutuo y la contribución igualitaria entre el viajero y la comunidad anfitriona]]', '[[an unequal dynamic where the traveller assumes authority to help, without properly considering what local people actually need|una dinámica desigual en la que el viajero asume autoridad para ayudar, sin considerar adecuadamente lo que la gente local realmente necesita]]', '[[a relationship in which local communities guide foreign visitors and teach them about their cultural and social needs|una relación en la que las comunidades locales guían a los visitantes extranjeros y les enseñan sobre sus necesidades culturales y sociales]]'], correctAnswer: 1, explanation: '"Paternalistic" = treating others as a parent treats children — assuming you know what is best for them without consulting them.' }] },
    topicName: 'Reading',
  },
{
    id: 'c1-u13-r3',
