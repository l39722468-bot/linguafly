...
export const VOCAB_SECTORS: VocabSectorMeta[] = [
  ...
  { slug: "deportes-individuales", title: "Deportes individuales", description: "Vocabulario de atletismo, natación, ciclismo y otros deportes individuales en inglés.", icon: "🏃" },
