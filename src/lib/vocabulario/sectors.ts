...
export const VOCAB_SECTORS: VocabSectorMeta[] = [
  ...
  { slug: "belleza-y-cuidado-personal", title: "Belleza y cuidado personal", description: "Higiene, peluquería y cosmética.", icon: "✨" },
  { slug: "emociones-y-personalidad", title: "Emociones y personalidad", description: "Sentimientos y rasgos de carácter.", icon: "😊" },
  { slug: "colores-formas-y-tamanos", title: "Colores, formas y tamaños", description: "Descripción visual básica.", icon: "🎨" },
  ...
  { slug: "ciencia-y-laboratorio", title: "Ciencia y laboratorio", description: "Experimento, química y biología.", icon: "🔬" },
  ...
  { slug: "deportes-individuales", title: "Deportes individuales", description: "Atletismo, natación y más.", icon: "🏃" },
