...
export const metadata: Metadata = {
  title: `Temario curso inglés A1 | ${SITE_BRAND_NAME}`,
  description: "Consulta el temario completo del curso de inglés nivel A1 de Linguafly. Revisa las unidades, contenidos de gramática y competencias que aprenderás.",
  alternates: canonicalAlternates('/curso-a1/outline'),
};
...
async function OutlineContent() {
  ...
  try {
    ...
    console.error('[curso-a1/outline] Error loading course metadata:', err);
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md text-center">
          ...
          <Link href="/curso-a1/outline" className="text-blue-600 font-bold hover:underline">
            Recargar
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 print-py-4">
        <CourseOutlineTable units={courseMetadata.units} coursePath="/curso-a1" />
      </div>
    </div>
  );
}
