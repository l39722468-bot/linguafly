...
async function B2PreviewContent() {
  ...
  try {
    ...
    await maybeRedirectSequentialSubscriber('/curso-b2', 'ingles-b2', courseMetadata.totalUnits);
  } catch (err) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md text-center">
          ...
          <Link href="/curso-b2" className="text-violet-600 font-bold hover:underline">Recargar</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium">
              Curso completo de inglés B2 con {courseMetadata.totalUnits} unidades interactivas. Totalmente gratuito.
            </p>
          </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="text-center">
        ...
        <p className="text-slate-600 font-medium">Loading free B2 course...</p>
      </div>
    </div>
  );
}
