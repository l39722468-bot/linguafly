...
async function OutlineContent() {
  ...
  try {
    ...
    console.error('[curso-b1/outline] Error loading course metadata:', err);
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md text-center">
          ...
          <a href="/curso-b1/outline" className="text-emerald-600 font-bold hover:underline">Recargar</a>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 print-py-4">
          <div className="flex items-center justify-between mb-6 print-mb-3">
            <div className="flex flex-wrap items-center gap-3">
              <Link 
                href="/curso-b1"
                className="inline-flex items-center gap-2 text-sm font-bold text-emerald-600 hover:text-emerald-700 transition-colors print-hidden"
              >
          ...
          <div className="flex items-start gap-4 mb-4 print-mb-2">
            <div className="w-12 h-12 bg-emerald-100 text-emerald-600 rounded-xl flex items-center justify-center print-hidden">
      ...
      {/* Outline Table */}
      <div className="max-w-7xl mx-auto px-4 py-8 print-py-4">
        <CourseOutlineTable units={courseMetadata.units} coursePath="/curso-b1" />
      </div>
    </div>
  );
}
