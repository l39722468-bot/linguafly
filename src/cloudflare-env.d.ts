/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv src/cloudflare-env.d.ts` (hash: 853651d52a9876d14d26da7d36a4ce56)
// Runtime types generated with workerd@1.20260804.1 2026-08-12 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	WORKER_SELF_REFERENCE: Fetcher /* linguaflyapp1 */;
}
declare namespace Cloudflare {
	interface Env extends __BaseEnv_CloudflareEnv {}
}
interface CloudflareEnv extends __BaseEnv_CloudflareEnv {
	// Optional secrets/vars (set via `wrangler secret` / .dev.vars). Not part of
	// wrangler.jsonc bindings, so declared here.
